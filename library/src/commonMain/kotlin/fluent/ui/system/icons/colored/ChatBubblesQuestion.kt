...
public val FluentUi.Colored.ChatBubblesQuestion: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ChatBubblesQuestionPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Colored.ChatBubblesQuestion, contentDescription = null)
    }
}
