...
public val FluentUi.Regular.SelectAllOn: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun SelectAllOnPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.SelectAllOn, contentDescription = null)
    }
}
