...
public val FluentUi.Filled.AppsAddInOff: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun AppsAddInOffPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.AppsAddInOff, contentDescription = null)
    }
}
