...
public val FluentUi.Filled.ScanTypeOff: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ScanTypeOffPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.ScanTypeOff, contentDescription = null)
    }
}
