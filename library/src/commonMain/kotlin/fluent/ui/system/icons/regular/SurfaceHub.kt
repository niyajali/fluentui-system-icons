...
public val FluentUi.Regular.SurfaceHub: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun SurfaceHubPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.SurfaceHub, contentDescription = null)
    }
}
