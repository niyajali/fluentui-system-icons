...
public val FluentUi.Filled.DocumentQueueAdd: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun DocumentQueueAddPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.DocumentQueueAdd, contentDescription = null)
    }
}
