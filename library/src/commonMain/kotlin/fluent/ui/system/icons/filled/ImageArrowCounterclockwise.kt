...
public val FluentUi.Filled.ImageArrowCounterclockwise: ImageVector by
...
private fun ImageArrowCounterclockwisePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.ImageArrowCounterclockwise, contentDescription = null)
    }
}
