...
public val FluentUi.Filled.BatterySaver: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun BatterySaverPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.BatterySaver, contentDescription = null)
    }
}
