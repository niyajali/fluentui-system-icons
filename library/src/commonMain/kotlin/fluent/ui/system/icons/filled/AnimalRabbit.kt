...
public val FluentUi.Filled.AnimalRabbit: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun AnimalRabbitPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.AnimalRabbit, contentDescription = null)
    }
}
