...
public val FluentUi.Filled.ArrowAutofitWidthDotted: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ArrowAutofitWidthDottedPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.ArrowAutofitWidthDotted, contentDescription = null)
    }
}
