...
public val FluentUi.Regular.LightbulbCheckmark: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun LightbulbCheckmarkPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.LightbulbCheckmark, contentDescription = null)
    }
}
