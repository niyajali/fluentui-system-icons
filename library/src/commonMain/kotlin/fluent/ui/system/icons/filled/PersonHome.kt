...
public val FluentIcons.Filled.PersonHome: ImageVector
    get() {
        if (_PersonHome != null) {
            return _PersonHome!!
        }
        _PersonHome = ImageVector.Builder(
...
private var _PersonHome: ImageVector? = null

@Preview
@Composable
private fun PersonHomePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.PersonHome, contentDescription = null)
    }
}
