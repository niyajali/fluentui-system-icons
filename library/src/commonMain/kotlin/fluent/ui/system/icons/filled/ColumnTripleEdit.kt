...
public val FluentUi.Filled.ColumnTripleEdit: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ColumnTripleEditPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.ColumnTripleEdit, contentDescription = null)
    }
}
