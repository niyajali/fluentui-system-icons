...
public val FluentUi.Filled.NumberCircle7: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun NumberCircle7Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.NumberCircle7, contentDescription = null)
    }
}
