...
public val FluentUi.Filled.ArrowAutofitHeight: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ArrowAutofitHeightPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.ArrowAutofitHeight, contentDescription = null)
    }
}
