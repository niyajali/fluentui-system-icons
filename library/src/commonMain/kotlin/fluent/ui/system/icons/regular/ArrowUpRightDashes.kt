...
public val FluentIcons.Regular.ArrowUpRightDashes: ImageVector
    get() {
        if (_ArrowUpRightDashes != null) {
            return _ArrowUpRightDashes!!
        }
        _ArrowUpRightDashes = ImageVector.Builder(
...
private var _ArrowUpRightDashes: ImageVector? = null

@Preview
@Composable
private fun ArrowUpRightDashesPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.ArrowUpRightDashes, contentDescription = null)
    }
}
