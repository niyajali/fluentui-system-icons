...
public val FluentUi.Filled.WalkieTalkie: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun WalkieTalkiePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.WalkieTalkie, contentDescription = null)
    }
}
