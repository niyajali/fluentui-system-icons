...
public val FluentIcons.Regular.CalendarTemplate: ImageVector
    get() {
        if (_CalendarTemplate != null) {
            return _CalendarTemplate!!
        }
        _CalendarTemplate = ImageVector.Builder(
...
private var _CalendarTemplate: ImageVector? = null
