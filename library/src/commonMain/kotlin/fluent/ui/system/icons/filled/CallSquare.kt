...
public val FluentIcons.Filled.CallSquare: ImageVector
    get() {
        if (_CallSquare != null) {
            return _CallSquare!!
        }
        _CallSquare = ImageVector.Builder(
            name = "Filled.CallSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
private var _CallSquare: ImageVector? = null

@Preview
@Composable
private fun CallSquarePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.CallSquare, contentDescription = null)
    }
}
