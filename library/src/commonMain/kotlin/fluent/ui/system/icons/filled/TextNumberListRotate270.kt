...
public val FluentIcons.Filled.TextNumberListRotate270: ImageVector
    get() {
        if (_TextNumberListRotate270 != null) {
            return _TextNumberListRotate270!!
        }
        _TextNumberListRotate270 = ImageVector.Builder(
            name = "Filled.TextNumberListRotate270",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                moveTo(2.75f, 18f)
                curveTo(2.396f, 18f, 2.09f, 18.248f, 2.016f, 18.594f)
                ...
                curveTo(8f, 18.336f, 7.664f, 18f, 7.25f, 18f)
                lineTo(2.75f, 18f)
                close()
                moveTo(18f, 4.5f)
                verticalLineTo(13f)
                ...
                curveTo(19.552f, 14f, 20f, 13.553f, 20f, 13f)
                verticalLineTo(4.5f)
                lineTo(19.993f, 4.384f)
                curveTo(19.936f, 3.887f, 19.513f, 3.5f, 19f, 3.5f)
                ...
                curveTo(13.052f, 14f, 13.5f, 13.553f, 13.5f, 13f)
                verticalLineTo(4.5f)
                lineTo(13.493f, 4.384f)
                curveTo(13.436f, 3.887f, 13.013f, 3.5f, 12.5f, 3.5f)
                ...
                curveTo(6.552f, 14f, 7f, 13.553f, 7f, 13f)
                verticalLineTo(4.5f)
                lineTo(6.993f, 4.384f)
                curveTo(6.936f, 3.887f, 6.513f, 3.5f, 6f, 3.5f)
                ...
                curveTo(11.62f, 17f, 12.08f, 17.271f, 12.421f, 17.606f)
                ...
                curveTo(14.664f, 17f, 15f, 17.336f, 15f, 17.75f)
                verticalLineTo(20.25f)
                curveTo(15f, 20.664f, 14.664f, 21f, 14.25f, 21f)
                curveTo(12.936f, 21f, 12.297f, 20.016f, 11.913f, 19.425f)
                lineTo(11.874f, 19.365f)
                curveTo(11.668f, 19.047f, 11.528f, 18.832f, 11.369f, 18.675f)
                curveTo(11.233f, 18.542f, 11.131f, 18.5f, 11f, 18.5f)
                ...
                curveTo(21.842f, 20.119f, 22f, 19.63f, 22f, 19f)
                curveTo(22f, 18.361f, 21.819f, 17.804f, 21.461f, 17.399f)
                curveTo(21.1f, 16.991f, 20.603f, 16.788f, 20.101f, 16.805f)
                curveTo(19.685f, 16.818f, 19.305f, 16.971f, 19f, 17.23f)
                curveTo(18.695f, 16.971f, 18.316f, 16.818f, 17.899f, 16.805f)
                curveTo(17.397f, 16.788f, 16.9f, 16.991f, 16.54f, 17.399f)
                curveTo(16.181f, 17.804f, 16f, 18.361f, 16f, 19f)
                curveTo(16f, 19.63f, 16.158f, 20.119f, 16.329f, 20.46f)
...
private fun TextNumberListRotate270Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.TextNumberListRotate270, contentDescription = null)
    }
}
