...
public val FluentIcons.Regular.LockClosedRibbon: ImageVector
    get() {
        if (_LockClosedRibbon != null) {
            return _LockClosedRibbon!!
        }
        _LockClosedRibbon = ImageVector.Builder(
            name = "Regular.LockClosedRibbon",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                ...
                curveTo(18.822f, 11.042f, 19.156f, 11.003f, 19.5f, 11.003f)
...
private var _LockClosedRibbon: ImageVector? = null

@Preview
@Composable
private fun LockClosedRibbonPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.LockClosedRibbon, contentDescription = null)
    }
}
