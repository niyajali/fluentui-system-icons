...
public val FluentUi.Regular.GlobeSync: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun GlobeSyncPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.GlobeSync, contentDescription = null)
    }
}
