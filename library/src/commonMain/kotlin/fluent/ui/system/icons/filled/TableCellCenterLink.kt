...
public val FluentIcons.Filled.TableCellCenterLink: ImageVector
    get() {
        if (_TableCellCenterLink != null) {
            return _TableCellCenterLink!!
        }
        _TableCellCenterLink = ImageVector.Builder(
            name = "Filled.TableCellCenterLink",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
private var _TableCellCenterLink: ImageVector? = null

@Preview
@Composable
private fun TableCellCenterLinkPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.TableCellCenterLink, contentDescription = null)
    }
}
