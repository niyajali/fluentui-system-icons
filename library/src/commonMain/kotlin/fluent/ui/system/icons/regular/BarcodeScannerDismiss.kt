...
public val FluentUi.Regular.BarcodeScannerDismiss: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun BarcodeScannerDismissPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.BarcodeScannerDismiss, contentDescription = null)
    }
}
