...
public val FluentUi.Filled.ArrowPrevious: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ArrowPreviousPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.ArrowPrevious, contentDescription = null)
    }
}
