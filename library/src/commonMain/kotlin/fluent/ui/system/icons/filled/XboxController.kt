...
public val FluentIcons.Filled.XboxController: ImageVector
    get() {
        if (_XboxController != null) {
            return _XboxController!!
        }
        _XboxController = ImageVector.Builder(
...
private fun XboxControllerPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.XboxController, contentDescription = null)
    }
}
