...
public val FluentUi.Regular.SlideMicrophone: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun SlideMicrophonePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.SlideMicrophone, contentDescription = null)
    }
}
