...
public val FluentIcons.Filled.TextIndentDecrease: ImageVector
    get() {
        if (_TextIndentDecrease != null) {
            return _TextIndentDecrease!!
        }
        _TextIndentDecrease = ImageVector.Builder(
...
private fun TextIndentDecreasePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.TextIndentDecrease, contentDescription = null)
    }
}
