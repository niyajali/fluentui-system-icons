...
public val FluentUi.Regular.BrightnessLow: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun BrightnessLowPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.BrightnessLow, contentDescription = null)
    }
}
