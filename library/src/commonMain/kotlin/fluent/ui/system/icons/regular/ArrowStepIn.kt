...
public val FluentUi.Regular.ArrowStepIn: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ArrowStepInPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.ArrowStepIn, contentDescription = null)
    }
}
