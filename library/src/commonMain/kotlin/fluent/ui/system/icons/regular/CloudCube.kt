...
public val FluentIcons.Regular.CloudCube: ImageVector
    get() {
        if (_CloudCube != null) {
            return _CloudCube!!
        }
        _CloudCube = ImageVector.Builder(
...
private var _CloudCube: ImageVector? = null

@Preview
@Composable
private fun CloudCubePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.CloudCube, contentDescription = null)
    }
}
