...
public val FluentUi.Filled.VehicleTractor: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun VehicleTractorPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.VehicleTractor, contentDescription = null)
    }
}
