...
public val FluentIcons.Regular.EmojiMeme: ImageVector
    get() {
        if (_EmojiMeme != null) {
            return _EmojiMeme!!
        }
        _EmojiMeme = ImageVector.Builder(
...
private var _EmojiMeme: ImageVector? = null

@Preview
@Composable
private fun EmojiMemePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.EmojiMeme, contentDescription = null)
    }
}
