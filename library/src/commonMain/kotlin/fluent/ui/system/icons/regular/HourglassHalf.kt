...
public val FluentUi.Regular.HourglassHalf: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun HourglassHalfPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.HourglassHalf, contentDescription = null)
    }
}
