...
public val FluentIcons.Filled.TextIndentDecreaseLtrRotate270: ImageVector
    get() {
        if (_TextIndentDecreaseLtrRotate270 != null) {
            return _TextIndentDecreaseLtrRotate270!!
        }
        _TextIndentDecreaseLtrRotate270 = ImageVector.Builder(
            name = "Filled.TextIndentDecreaseLtrRotate270",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
@Preview
@Composable
private fun TextIndentDecreaseLtrRotate270Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.TextIndentDecreaseLtrRotate270, contentDescription = null)
    }
}
