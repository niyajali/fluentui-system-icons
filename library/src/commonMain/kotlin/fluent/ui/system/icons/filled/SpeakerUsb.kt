...
public val FluentUi.Filled.SpeakerUsb: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun SpeakerUsbPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.SpeakerUsb, contentDescription = null)
    }
}
