...
public val FluentIcons.Filled.TextDirectionHorizontalRtl: ImageVector
    get() {
        if (_TextDirectionHorizontalRtl != null) {
            return _TextDirectionHorizontalRtl!!
        }
        _TextDirectionHorizontalRtl = ImageVector.Builder(
            name = "Filled.TextDirectionHorizontalRtl",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
@Preview
@Composable
private fun TextDirectionHorizontalRtlPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.TextDirectionHorizontalRtl, contentDescription = null)
    }
}
