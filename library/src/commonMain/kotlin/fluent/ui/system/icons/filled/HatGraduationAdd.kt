...
public val FluentIcons.Filled.HatGraduationAdd: ImageVector
    get() {
        if (_HatGraduationAdd != null) {
            return _HatGraduationAdd!!
        }
        _HatGraduationAdd = ImageVector.Builder(
            name = "Filled.HatGraduationAdd",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                ...
                close()
                moveTo(17.5f, 13f)
                curveTo(17.591f, 13f, 17.682f, 12.998f, 17.773f, 12.994f)
                ...
                curveTo(11.354f, 4.079f, 11f, 5.248f, 11f, 6.5f)
...
private var _HatGraduationAdd: ImageVector? = null

@Preview
@Composable
private fun HatGraduationAddPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.HatGraduationAdd, contentDescription = null)
    }
}
