...
public val FluentUi.Regular.AccessibilityError: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun AccessibilityErrorPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.AccessibilityError, contentDescription = null)
    }
}
