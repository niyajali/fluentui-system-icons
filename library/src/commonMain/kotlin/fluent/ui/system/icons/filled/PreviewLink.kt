...
public val FluentUi.Filled.PreviewLink: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun PreviewLinkPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.PreviewLink, contentDescription = null)
    }
}
