...
public val FluentUi.Filled.TableCellCenterSearch: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun TableCellCenterSearchPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.TableCellCenterSearch, contentDescription = null)
    }
}
