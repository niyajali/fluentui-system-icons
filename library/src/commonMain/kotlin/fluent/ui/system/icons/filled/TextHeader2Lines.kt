...
public val FluentUi.Filled.TextHeader2Lines: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun TextHeader2LinesPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.TextHeader2Lines, contentDescription = null)
    }
}
