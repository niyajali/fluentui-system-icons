...
public val FluentUi.Filled.TextPositionThrough: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun TextPositionThroughPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.TextPositionThrough, contentDescription = null)
    }
}
