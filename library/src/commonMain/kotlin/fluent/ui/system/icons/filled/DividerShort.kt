...
public val FluentUi.Filled.DividerShort: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun DividerShortPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.DividerShort, contentDescription = null)
    }
}
