...
public val FluentUi.Filled.ResizeLarge: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ResizeLargePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.ResizeLarge, contentDescription = null)
    }
}
