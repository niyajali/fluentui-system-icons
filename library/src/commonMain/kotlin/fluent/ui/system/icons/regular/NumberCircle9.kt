...
public val FluentIcons.Regular.NumberCircle9: ImageVector
    get() {
        if (_NumberCircle9 != null) {
            return _NumberCircle9!!
        }
        _NumberCircle9 = ImageVector.Builder(
...
private var _NumberCircle9: ImageVector? = null

@Preview
@Composable
private fun NumberCircle9Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.NumberCircle9, contentDescription = null)
    }
}
