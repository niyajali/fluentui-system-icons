...
public val FluentIcons.Filled.TextArrowDownRightColumn: ImageVector
    get() {
        if (_TextArrowDownRightColumn != null) {
            return _TextArrowDownRightColumn!!
        }
        _TextArrowDownRightColumn = ImageVector.Builder(
...
private fun TextArrowDownRightColumnPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.TextArrowDownRightColumn, contentDescription = null)
    }
}
