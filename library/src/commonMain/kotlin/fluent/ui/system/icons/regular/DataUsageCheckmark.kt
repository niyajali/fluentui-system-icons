...
public val FluentIcons.Regular.DataUsageCheckmark: ImageVector
    get() {
        if (_DataUsageCheckmark != null) {
            return _DataUsageCheckmark!!
        }
        _DataUsageCheckmark = ImageVector.Builder(
...
private var _DataUsageCheckmark: ImageVector? = null

@Preview
@Composable
private fun DataUsageCheckmarkPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.DataUsageCheckmark, contentDescription = null)
    }
}
