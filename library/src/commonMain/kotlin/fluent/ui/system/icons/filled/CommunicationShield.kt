...
public val FluentUi.Filled.CommunicationShield: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun CommunicationShieldPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.CommunicationShield, contentDescription = null)
    }
}
