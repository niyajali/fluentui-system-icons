...
public val FluentIcons.Filled.TagAdd: ImageVector
    get() {
        if (_TagAdd != null) {
            return _TagAdd!!
        }
        _TagAdd = ImageVector.Builder(
            name = "Filled.TagAdd",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _TagAdd: ImageVector? = null

@Preview
@Composable
private fun TagAddPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.TagAdd, contentDescription = null)
    }
}
