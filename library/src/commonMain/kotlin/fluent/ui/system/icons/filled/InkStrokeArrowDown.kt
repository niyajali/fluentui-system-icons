...
public val FluentUi.Filled.InkStrokeArrowDown: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun InkStrokeArrowDownPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.InkStrokeArrowDown, contentDescription = null)
    }
}
