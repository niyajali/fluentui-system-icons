...
public val FluentIcons.Regular.CalendarShield: ImageVector
    get() {
        if (_CalendarShield != null) {
            return _CalendarShield!!
        }
        _CalendarShield = ImageVector.Builder(
...
private fun CalendarShieldPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.CalendarShield, contentDescription = null)
    }
}
