...
public val FluentUi.Filled.Cellular5G: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun Cellular5GPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.Cellular5G, contentDescription = null)
    }
}
