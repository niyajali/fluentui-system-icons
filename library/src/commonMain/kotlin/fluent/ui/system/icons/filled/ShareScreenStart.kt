...
public val FluentUi.Filled.ShareScreenStart: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ShareScreenStartPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.ShareScreenStart, contentDescription = null)
    }
}
