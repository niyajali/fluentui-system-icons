...
public val FluentUi.Regular.BorderOutside: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun BorderOutsidePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.BorderOutside, contentDescription = null)
    }
}
