...
public val FluentUi.Regular.DocumentJavascript: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun DocumentJavascriptPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.DocumentJavascript, contentDescription = null)
    }
}
