...
public val FluentUi.Filled.ShoppingBagArrowLeft: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ShoppingBagArrowLeftPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.ShoppingBagArrowLeft, contentDescription = null)
    }
}
