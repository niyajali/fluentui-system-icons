...
public val FluentUi.Regular.FolderOpenDown: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun FolderOpenDownPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.FolderOpenDown, contentDescription = null)
    }
}
