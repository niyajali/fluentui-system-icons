...
public val FluentIcons.Regular.CardUiPortraitFlip: ImageVector
    get() {
        if (_CardUiPortraitFlip != null) {
            return _CardUiPortraitFlip!!
        }
        _CardUiPortraitFlip = ImageVector.Builder(
            name = "Regular.CardUiPortraitFlip",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                ...
                curveTo(16f, 7.164f, 15.664f, 7.5f, 15.25f, 7.5f)
...
private var _CardUiPortraitFlip: ImageVector? = null

@Preview
@Composable
private fun CardUiPortraitFlipPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.CardUiPortraitFlip, contentDescription = null)
    }
}
