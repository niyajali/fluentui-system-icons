...
public val FluentUi.Regular.CheckmarkStarburst: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun CheckmarkStarburstPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.CheckmarkStarburst, contentDescription = null)
    }
}
