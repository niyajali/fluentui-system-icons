...
public val FluentUi.Filled.ShiftsAvailability: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ShiftsAvailabilityPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.ShiftsAvailability, contentDescription = null)
    }
}
