...
public val FluentUi.Regular.NumberSymbol: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun NumberSymbolPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.NumberSymbol, contentDescription = null)
    }
}
