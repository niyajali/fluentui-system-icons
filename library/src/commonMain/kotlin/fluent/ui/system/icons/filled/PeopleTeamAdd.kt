...
public val FluentUi.Filled.PeopleTeamAdd: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun PeopleTeamAddPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.PeopleTeamAdd, contentDescription = null)
    }
}
