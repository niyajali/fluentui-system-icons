...
public val FluentIcons.Regular.GlanceHorizontalSparkles: ImageVector
    get() {
        if (_GlanceHorizontalSparkles != null) {
            return _GlanceHorizontalSparkles!!
        }
        _GlanceHorizontalSparkles = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                ...
                curveTo(11.217f, 3.002f, 12f, 3.785f, 12f, 4.752f)
                verticalLineTo(9.252f)
                curveTo(12f, 10.219f, 11.217f, 11.002f, 10.25f, 11.002f)
                horizontalLineTo(4.75f)
                curveTo(3.783f, 11.002f, 3f, 10.219f, 3f, 9.252f)
                verticalLineTo(4.752f)
                curveTo(3f, 3.785f, 3.783f, 3.002f, 4.75f, 3.002f)
                horizontalLineTo(10.25f)
                close()
                moveTo(10.5f, 9.252f)
                verticalLineTo(4.752f)
                curveTo(10.5f, 4.614f, 10.388f, 4.502f, 10.25f, 4.502f)
                horizontalLineTo(4.75f)
                curveTo(4.612f, 4.502f, 4.5f, 4.614f, 4.5f, 4.752f)
                verticalLineTo(9.252f)
                curveTo(4.5f, 9.39f, 4.612f, 9.502f, 4.75f, 9.502f)
                horizontalLineTo(10.25f)
                curveTo(10.388f, 9.502f, 10.5f, 9.39f, 10.5f, 9.252f)
                close()
                moveTo(7.238f, 12.984f)
                curveTo(8.204f, 12.984f, 8.988f, 13.767f, 8.988f, 14.734f)
                verticalLineTo(19.248f)
                curveTo(8.988f, 20.215f, 8.204f, 20.998f, 7.238f, 20.998f)
                horizontalLineTo(4.75f)
                curveTo(3.783f, 20.998f, 3f, 20.215f, 3f, 19.248f)
                verticalLineTo(14.734f)
                curveTo(3f, 13.767f, 3.783f, 12.984f, 4.75f, 12.984f)
                horizontalLineTo(7.238f)
                close()
                moveTo(7.488f, 19.248f)
                verticalLineTo(14.734f)
                curveTo(7.488f, 14.596f, 7.376f, 14.484f, 7.238f, 14.484f)
                horizontalLineTo(4.75f)
                curveTo(4.612f, 14.484f, 4.5f, 14.596f, 4.5f, 14.734f)
                verticalLineTo(19.248f)
                curveTo(4.5f, 19.386f, 4.612f, 19.498f, 4.75f, 19.498f)
                horizontalLineTo(7.238f)
                curveTo(7.376f, 19.498f, 7.488f, 19.386f, 7.488f, 19.248f)
                close()
                moveTo(19.252f, 12.998f)
                curveTo(20.218f, 12.998f, 21.002f, 13.782f, 21.002f, 14.748f)
                verticalLineTo(19.248f)
                curveTo(21.002f, 20.215f, 20.218f, 20.998f, 19.252f, 20.998f)
                horizontalLineTo(12.752f)
                curveTo(11.785f, 20.998f, 11.002f, 20.215f, 11.002f, 19.248f)
                verticalLineTo(14.748f)
                lineTo(11.007f, 14.605f)
                curveTo(11.08f, 13.705f, 11.833f, 12.998f, 12.752f, 12.998f)
                horizontalLineTo(19.252f)
                close()
                moveTo(19.502f, 19.248f)
                verticalLineTo(14.748f)
                curveTo(19.502f, 14.61f, 19.39f, 14.498f, 19.252f, 14.498f)
                horizontalLineTo(12.752f)
                curveTo(12.633f, 14.498f, 12.534f, 14.58f, 12.508f, 14.691f)
                lineTo(12.502f, 14.748f)
                verticalLineTo(19.248f)
                curveTo(12.502f, 19.386f, 12.614f, 19.498f, 12.752f, 19.498f)
                horizontalLineTo(19.252f)
                curveTo(19.39f, 19.498f, 19.502f, 19.386f, 19.502f, 19.248f)
                close()
            }
        }.build()
