...
public val FluentUi.Regular.ArrowTrendingText: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ArrowTrendingTextPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.ArrowTrendingText, contentDescription = null)
    }
}
