...
public val FluentUi.Regular.CheckboxWarning: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun CheckboxWarningPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.CheckboxWarning, contentDescription = null)
    }
}
