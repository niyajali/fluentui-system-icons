...
public val FluentUi.Filled.CalendarAgenda: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun CalendarAgendaPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.CalendarAgenda, contentDescription = null)
    }
}
