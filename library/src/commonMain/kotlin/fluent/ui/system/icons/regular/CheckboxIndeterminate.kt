...
public val FluentUi.Regular.CheckboxIndeterminate: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun CheckboxIndeterminatePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.CheckboxIndeterminate, contentDescription = null)
    }
}
