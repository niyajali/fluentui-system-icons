...
public val FluentUi.Regular.SkipForward30: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun SkipForward30Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.SkipForward30, contentDescription = null)
    }
}
