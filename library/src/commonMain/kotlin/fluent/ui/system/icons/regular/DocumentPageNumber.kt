...
public val FluentUi.Regular.DocumentPageNumber: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun DocumentPageNumberPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.DocumentPageNumber, contentDescription = null)
    }
}
