...
public val FluentUi.Filled.PlugDisconnected: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun PlugDisconnectedPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.PlugDisconnected, contentDescription = null)
    }
}
