...
public val FluentUi.Regular.ScanCamera: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ScanCameraPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.ScanCamera, contentDescription = null)
    }
}
