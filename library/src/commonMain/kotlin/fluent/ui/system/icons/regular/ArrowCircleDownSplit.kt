...
public val FluentUi.Regular.ArrowCircleDownSplit: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ArrowCircleDownSplitPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.ArrowCircleDownSplit, contentDescription = null)
    }
}
