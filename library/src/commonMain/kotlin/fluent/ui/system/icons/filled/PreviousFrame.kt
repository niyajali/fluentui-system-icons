...
public val FluentIcons.Filled.PreviousFrame: ImageVector
    get() {
        if (_PreviousFrame != null) {
            return _PreviousFrame!!
        }
        _PreviousFrame = ImageVector.Builder(
...
private var _PreviousFrame: ImageVector? = null

@Preview
@Composable
private fun PreviousFramePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.PreviousFrame, contentDescription = null)
    }
}
