...
public val FluentIcons.Filled.TextIndentIncreaseLtr90: ImageVector
    get() {
        if (_TextIndentIncreaseLtr90 != null) {
            return _TextIndentIncreaseLtr90!!
        }
        _TextIndentIncreaseLtr90 = ImageVector.Builder(
            name = "Filled.TextIndentIncreaseLtr90",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
@Preview
@Composable
private fun TextIndentIncreaseLtr90Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.TextIndentIncreaseLtr90, contentDescription = null)
    }
}
