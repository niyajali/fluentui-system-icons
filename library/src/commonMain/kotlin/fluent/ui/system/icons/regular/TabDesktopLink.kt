...
public val FluentIcons.Regular.TabDesktopLink: ImageVector
    get() {
        if (_TabDesktopLink != null) {
            return _TabDesktopLink!!
        }
        _TabDesktopLink = ImageVector.Builder(
...
private var _TabDesktopLink: ImageVector? = null

@Preview
@Composable
private fun TabDesktopLinkPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.TabDesktopLink, contentDescription = null)
    }
}
