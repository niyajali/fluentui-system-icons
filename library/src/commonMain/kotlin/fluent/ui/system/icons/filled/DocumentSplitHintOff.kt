...
public val FluentUi.Filled.DocumentSplitHintOff: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun DocumentSplitHintOffPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.DocumentSplitHintOff, contentDescription = null)
    }
}
