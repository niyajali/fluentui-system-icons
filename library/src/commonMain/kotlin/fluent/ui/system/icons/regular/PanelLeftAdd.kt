...
public val FluentUi.Regular.PanelLeftAdd: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun PanelLeftAddPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.PanelLeftAdd, contentDescription = null)
    }
}
