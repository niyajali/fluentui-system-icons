...
public val FluentUi.Filled.WeatherRainShowersNight: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun WeatherRainShowersNightPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.WeatherRainShowersNight, contentDescription = null)
    }
}
