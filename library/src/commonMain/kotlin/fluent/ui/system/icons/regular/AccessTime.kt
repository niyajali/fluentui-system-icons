...
public val FluentUi.Regular.AccessTime: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun AccessTimePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.AccessTime, contentDescription = null)
    }
}
