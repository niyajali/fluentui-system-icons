...
public val FluentUi.Light.CalendarWorkWeek: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun CalendarWorkWeekPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Light.CalendarWorkWeek, contentDescription = null)
    }
}
