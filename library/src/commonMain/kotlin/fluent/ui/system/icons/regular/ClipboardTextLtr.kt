...
public val FluentUi.Regular.ClipboardTextLtr: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ClipboardTextLtrPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.ClipboardTextLtr, contentDescription = null)
    }
}
