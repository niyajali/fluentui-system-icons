...
public val FluentUi.Regular.GlassesOff: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun GlassesOffPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.GlassesOff, contentDescription = null)
    }
}
