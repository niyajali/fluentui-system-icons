...
public val FluentIcons.Regular.GlobeArrowUp: ImageVector
    get() {
        if (_GlobeArrowUp != null) {
            return _GlobeArrowUp!!
        }
        _GlobeArrowUp = ImageVector.Builder(
            name = "Regular.GlobeArrowUp",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
private var _GlobeArrowUp: ImageVector? = null

@Preview
@Composable
private fun GlobeArrowUpPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.GlobeArrowUp, contentDescription = null)
    }
}
