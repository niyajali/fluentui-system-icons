...
public val FluentIcons.Regular.StackAdd: ImageVector
    get() {
        if (_StackAdd != null) {
            return _StackAdd!!
        }
        _StackAdd = ImageVector.Builder(
...
private var _StackAdd: ImageVector? = null

@Preview
@Composable
private fun StackAddPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.StackAdd, contentDescription = null)
    }
}
