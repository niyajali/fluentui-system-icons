...
public val FluentUi.Regular.ScanTypeOff: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ScanTypeOffPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.ScanTypeOff, contentDescription = null)
    }
}
