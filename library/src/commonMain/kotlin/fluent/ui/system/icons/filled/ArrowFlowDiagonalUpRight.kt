...
public val FluentIcons.Filled.ArrowFlowDiagonalUpRight: ImageVector
    get() {
        if (_ArrowFlowDiagonalUpRight != null) {
            return _ArrowFlowDiagonalUpRight!!
        }
        _ArrowFlowDiagonalUpRight = ImageVector.Builder(
...
private var _ArrowFlowDiagonalUpRight: ImageVector? = null

@Preview
@Composable
private fun ArrowFlowDiagonalUpRightPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.ArrowFlowDiagonalUpRight, contentDescription = null)
    }
}
