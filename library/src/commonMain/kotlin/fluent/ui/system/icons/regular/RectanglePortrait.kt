...
public val FluentIcons.Regular.RectanglePortrait: ImageVector
    get() {
        if (_RectanglePortrait != null) {
            return _RectanglePortrait!!
        }
        _RectanglePortrait = ImageVector.Builder(
...
private var _RectanglePortrait: ImageVector? = null
