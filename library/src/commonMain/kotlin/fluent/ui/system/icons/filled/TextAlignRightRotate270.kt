...
public val FluentIcons.Filled.TextAlignRightRotate270: ImageVector
    get() {
        if (_TextAlignRightRotate270 != null) {
            return _TextAlignRightRotate270!!
        }
        _TextAlignRightRotate270 = ImageVector.Builder(
            name = "Filled.TextAlignRightRotate270",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
private fun TextAlignRightRotate270Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.TextAlignRightRotate270, contentDescription = null)
    }
}
