...
public val FluentUi.Filled.WeatherRainShowersDay: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun WeatherRainShowersDayPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.WeatherRainShowersDay, contentDescription = null)
    }
}
