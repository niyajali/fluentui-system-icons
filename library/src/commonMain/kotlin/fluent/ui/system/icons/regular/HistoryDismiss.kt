...
public val FluentUi.Regular.HistoryDismiss: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun HistoryDismissPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.HistoryDismiss, contentDescription = null)
    }
}
