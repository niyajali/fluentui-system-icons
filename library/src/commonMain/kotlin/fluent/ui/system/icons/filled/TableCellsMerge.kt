...
public val FluentUi.Filled.TableCellsMerge: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun TableCellsMergePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.TableCellsMerge, contentDescription = null)
    }
}
