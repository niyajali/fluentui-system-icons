...
public val FluentUi.Regular.MoviesAndTv: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun MoviesAndTvPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.MoviesAndTv, contentDescription = null)
    }
}
