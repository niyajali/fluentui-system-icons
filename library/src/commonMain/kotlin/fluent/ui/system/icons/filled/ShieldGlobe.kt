...
public val FluentUi.Filled.ShieldGlobe: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ShieldGlobePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.ShieldGlobe, contentDescription = null)
    }
}
