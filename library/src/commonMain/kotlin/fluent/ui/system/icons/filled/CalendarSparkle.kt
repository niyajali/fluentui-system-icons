...
public val FluentIcons.Filled.CalendarSparkle: ImageVector
    get() {
        if (_CalendarSparkle != null) {
            return _CalendarSparkle!!
        }
        _CalendarSparkle = ImageVector.Builder(
            name = "Filled.CalendarSparkle",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                ...
                curveTo(14.022f, 6.752f, 13.714f, 6.566f, 13.4f, 6.459f)
                lineTo(12f, 5.999f)
                curveTo(11.416f, 5.746f, 11.002f, 5.104f, 11f, 4.469f)
                curveTo(11.002f, 3.804f, 11.424f, 3.224f, 12.047f, 3f)
                close()
                moveTo(21f, 13.936f)
                curveTo(20.849f, 14.008f, 20.671f, 14.05f, 20.46f, 14.05f)
                curveTo(19.5f, 14.05f, 19.23f, 13.193f, 18.994f, 12.444f)
                lineTo(18.98f, 12.399f)
                curveTo(18.864f, 12.046f, 18.434f, 11.936f, 18.074f, 11.845f)
                curveTo(17.987f, 11.823f, 17.903f, 11.802f, 17.83f, 11.779f)
                curveTo(17.322f, 11.597f, 16.956f, 11.089f, 16.96f, 10.549f)
                curveTo(16.959f, 10.317f, 17.021f, 10.089f, 17.14f, 9.889f)
                curveTo(16.93f, 9.997f, 16.696f, 10.052f, 16.46f, 10.049f)
                curveTo(15.801f, 10.047f, 15.213f, 9.622f, 15f, 8.999f)
                lineTo(14.859f, 8.5f)
                horizontalLineTo(3f)
...
private fun CalendarSparklePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.CalendarSparkle, contentDescription = null)
    }
}
