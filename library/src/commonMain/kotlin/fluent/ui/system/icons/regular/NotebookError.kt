...
public val FluentUi.Regular.NotebookError: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun NotebookErrorPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.NotebookError, contentDescription = null)
    }
}
