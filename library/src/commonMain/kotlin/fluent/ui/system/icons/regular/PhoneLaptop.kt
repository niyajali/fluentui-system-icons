...
public val FluentUi.Regular.PhoneLaptop: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun PhoneLaptopPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.PhoneLaptop, contentDescription = null)
    }
}
