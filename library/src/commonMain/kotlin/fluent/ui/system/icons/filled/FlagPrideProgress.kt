...
public val FluentIcons.Filled.FlagPrideProgress: ImageVector
    get() {
        if (_FlagPrideProgress != null) {
            return _FlagPrideProgress!!
        }
        _FlagPrideProgress = ImageVector.Builder(
...
private var _FlagPrideProgress: ImageVector? = null

@Preview
@Composable
private fun FlagPrideProgressPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.FlagPrideProgress, contentDescription = null)
    }
}
