...
public val FluentIcons.Regular.NumberCircle8: ImageVector
    get() {
        if (_NumberCircle8 != null) {
            return _NumberCircle8!!
        }
        _NumberCircle8 = ImageVector.Builder(
...
private var _NumberCircle8: ImageVector? = null

@Preview
@Composable
private fun NumberCircle8Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.NumberCircle8, contentDescription = null)
    }
}
