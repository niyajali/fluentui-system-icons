...
public val FluentUi.Regular.ShapeIntersect: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ShapeIntersectPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.ShapeIntersect, contentDescription = null)
    }
}
