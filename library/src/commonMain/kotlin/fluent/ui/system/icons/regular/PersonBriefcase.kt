...
public val FluentIcons.Regular.PersonBriefcase: ImageVector
    get() {
        if (_PersonBriefcase != null) {
            return _PersonBriefcase!!
        }
        _PersonBriefcase = ImageVector.Builder(
...
private var _PersonBriefcase: ImageVector? = null

@Preview
@Composable
private fun PersonBriefcasePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.PersonBriefcase, contentDescription = null)
    }
}
