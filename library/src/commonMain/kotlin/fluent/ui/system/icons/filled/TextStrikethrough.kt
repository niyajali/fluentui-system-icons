...
public val FluentUi.Filled.TextStrikethrough: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun TextStrikethroughPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.TextStrikethrough, contentDescription = null)
    }
}
