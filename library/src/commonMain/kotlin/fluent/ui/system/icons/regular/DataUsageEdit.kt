...
public val FluentUi.Regular.DataUsageEdit: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun DataUsageEditPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.DataUsageEdit, contentDescription = null)
    }
}
