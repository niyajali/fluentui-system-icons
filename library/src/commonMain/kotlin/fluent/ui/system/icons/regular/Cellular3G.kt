...
public val FluentUi.Regular.Cellular3G: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun Cellular3GPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.Cellular3G, contentDescription = null)
    }
}
