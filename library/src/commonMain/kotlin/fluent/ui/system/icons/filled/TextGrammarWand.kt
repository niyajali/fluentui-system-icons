...
public val FluentUi.Filled.TextGrammarWand: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun TextGrammarWandPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.TextGrammarWand, contentDescription = null)
    }
}
