...
public val FluentUi.Regular.BinRecycleFull: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun BinRecycleFullPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.BinRecycleFull, contentDescription = null)
    }
}
