...
public val FluentIcons.Regular.PeopleSubtract: ImageVector
    get() {
        if (_PeopleSubtract != null) {
            return _PeopleSubtract!!
        }
        _PeopleSubtract = ImageVector.Builder(
            name = "Regular.PeopleSubtract",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                ...
                close()
                moveTo(17f, 6.5f)
                curveTo(16.171f, 6.5f, 15.5f, 7.172f, 15.5f, 8f)
                curveTo(15.5f, 8.828f, 16.171f, 9.5f, 17f, 9.5f)
                ...
                curveTo(13.996f, 17.776f, 14.22f, 18f, 14.495f, 18f)
...
private var _PeopleSubtract: ImageVector? = null

@Preview
@Composable
private fun PeopleSubtractPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.PeopleSubtract, contentDescription = null)
    }
}
