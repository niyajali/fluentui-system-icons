    ...
    get() {
        ...
        _TextBulletListSquareSparkle = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                ...
                curveTo(20.831f, 14.009f, 20.647f, 14.05f, 20.46f, 14.05f)
                curveTo(20.191f, 14.05f, 19.929f, 13.965f, 19.71f, 13.809f)
                curveTo(19.484f, 13.648f, 19.313f, 13.421f, 19.22f, 13.159f)
                lineTo(18.98f, 12.399f)
                curveTo(18.952f, 12.313f, 18.904f, 12.234f, 18.84f, 12.169f)
                curveTo(18.775f, 12.11f, 18.701f, 12.062f, 18.62f, 12.029f)
                lineTo(17.83f, 11.779f)
                curveTo(17.576f, 11.688f, 17.355f, 11.52f, 17.2f, 11.299f)
                curveTo(17.042f, 11.081f, 16.958f, 10.818f, 16.96f, 10.549f)
                curveTo(16.959f, 10.317f, 17.021f, 10.089f, 17.14f, 9.889f)
                curveTo(16.93f, 9.997f, 16.696f, 10.052f, 16.46f, 10.049f)
                curveTo(16.142f, 10.048f, 15.831f, 9.95f, 15.57f, 9.769f)
                ...
                curveTo(14.507f, 7.321f, 14.415f, 7.152f, 14.3f, 6.999f)
                lineTo(14.12f, 6.899f)
                curveTo(13.916f, 6.701f, 13.67f, 6.55f, 13.4f, 6.459f)
                lineTo(12f, 5.999f)
                curveTo(11.698f, 5.868f, 11.445f, 5.644f, 11.28f, 5.359f)
                curveTo(11.099f, 5.098f, 11.001f, 4.787f, 11f, 4.469f)
                curveTo(11.001f, 4.148f, 11.098f, 3.834f, 11.28f, 3.569f)
                curveTo(11.474f, 3.308f, 11.741f, 3.11f, 12.047f, 3f)
                close()
                moveTo(8.75f, 8.25f)
                ...
                horizontalLineTo(16.75f)
                curveTo(17.164f, 15f, 17.5f, 15.336f, 17.5f, 15.75f)
                curveTo(17.5f, 16.164f, 17.164f, 16.5f, 16.75f, 16.5f)
                horizontalLineTo(11.25f)
                close()
                moveTo(7.75f, 11f)
...
private fun TextBulletListSquareSparklePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.TextBulletListSquareSparkle, contentDescription = null)
    }
}
