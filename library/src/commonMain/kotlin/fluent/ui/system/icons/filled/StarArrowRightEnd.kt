...
public val FluentUi.Filled.StarArrowRightEnd: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun StarArrowRightEndPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.StarArrowRightEnd, contentDescription = null)
    }
}
