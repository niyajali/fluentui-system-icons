...
public val FluentIcons.Regular.EditLineHorizontal3: ImageVector
    get() {
        if (_EditLineHorizontal3 != null) {
            return _EditLineHorizontal3!!
        }
        _EditLineHorizontal3 = ImageVector.Builder(
...
private var _EditLineHorizontal3: ImageVector? = null

@Preview
@Composable
private fun EditLineHorizontal3Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.EditLineHorizontal3, contentDescription = null)
    }
}
