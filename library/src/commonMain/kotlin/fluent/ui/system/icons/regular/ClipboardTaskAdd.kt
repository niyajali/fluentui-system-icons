...
public val FluentUi.Regular.ClipboardTaskAdd: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ClipboardTaskAddPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.ClipboardTaskAdd, contentDescription = null)
    }
}
