...
public val FluentUi.Filled.Multiplier12X: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.Multiplier12X",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color(0xFF212121))) {
            ...
            curveTo(9.815f, 13.801f, 9.5f, 14.748f, 9.5f, 16f)
            curveTo(9.5f, 16.265f, 9.605f, 16.52f, 9.793f, 16.707f)
            curveTo(9.98f, 16.895f, 10.235f, 17f, 10.5f, 17f)
            horizontalLineTo(15.25f)
            curveTo(15.802f, 17f, 16.25f, 16.552f, 16.25f, 16f)
            curveTo(16.25f, 15.448f, 15.802f, 15f, 15.25f, 15f)
            ...
            close()
            moveTo(5.27f, 6.939f)
            curveTo(5.702f, 7.06f, 6f, 7.453f, 6f, 7.902f)
            verticalLineTo(16f)
            curveTo(6f, 16.552f, 5.553f, 17f, 5f, 17f)
...
private fun Multiplier12XPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.Multiplier12X, contentDescription = null)
    }
}
