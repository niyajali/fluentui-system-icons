...
public val FluentIcons.Regular.ArchiveArrowBack: ImageVector
    get() {
        if (_ArchiveArrowBack != null) {
            return _ArchiveArrowBack!!
        }
        _ArchiveArrowBack = ImageVector.Builder(
...
private fun ArchiveArrowBackPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.ArchiveArrowBack, contentDescription = null)
    }
}
