...
public val FluentUi.Regular.TabDesktopMultiple: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun TabDesktopMultiplePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.TabDesktopMultiple, contentDescription = null)
    }
}
