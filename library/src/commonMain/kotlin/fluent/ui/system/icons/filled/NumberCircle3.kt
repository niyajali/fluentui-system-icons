...
public val FluentIcons.Filled.NumberCircle3: ImageVector
    get() {
        if (_NumberCircle3 != null) {
            return _NumberCircle3!!
        }
        _NumberCircle3 = ImageVector.Builder(
            name = "Filled.NumberCircle3",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
private var _NumberCircle3: ImageVector? = null

@Preview
@Composable
private fun NumberCircle3Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.NumberCircle3, contentDescription = null)
    }
}
