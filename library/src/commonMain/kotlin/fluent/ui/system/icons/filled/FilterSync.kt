...
public val FluentUi.Filled.FilterSync: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.FilterSync",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color(0xFF212121))) {
            ...
            curveTo(13.226f, 12.489f, 12.537f, 11.805f, 12.022f, 11f)
            horizontalLineTo(8f)
            lineTo(7.883f, 11.007f)
            curveTo(7.386f, 11.064f, 7f, 11.487f, 7f, 12f)
...
private fun FilterSyncPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.FilterSync, contentDescription = null)
    }
}
