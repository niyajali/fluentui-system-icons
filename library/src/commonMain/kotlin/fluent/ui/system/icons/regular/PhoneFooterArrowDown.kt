...
public val FluentUi.Regular.PhoneFooterArrowDown: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun PhoneFooterArrowDownPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.PhoneFooterArrowDown, contentDescription = null)
    }
}
