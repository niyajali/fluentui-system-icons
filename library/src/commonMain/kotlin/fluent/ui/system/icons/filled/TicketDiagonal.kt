...
public val FluentUi.Filled.TicketDiagonal: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun TicketDiagonalPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.TicketDiagonal, contentDescription = null)
    }
}
