...
public val FluentUi.Regular.MailArrowDoubleBack: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun MailArrowDoubleBackPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.MailArrowDoubleBack, contentDescription = null)
    }
}
