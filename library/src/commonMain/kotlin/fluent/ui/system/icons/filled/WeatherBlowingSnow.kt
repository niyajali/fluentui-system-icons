...
public val FluentUi.Filled.WeatherBlowingSnow: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun WeatherBlowingSnowPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.WeatherBlowingSnow, contentDescription = null)
    }
}
