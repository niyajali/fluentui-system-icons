...
public val FluentIcons.Filled.TextNumberListLtr90: ImageVector
    get() {
        if (_TextNumberListLtr90 != null) {
            return _TextNumberListLtr90!!
        }
        _TextNumberListLtr90 = ImageVector.Builder(
            name = "Filled.TextNumberListLtr90",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                moveTo(21.25f, 6f)
                curveTo(21.604f, 6f, 21.91f, 5.752f, 21.984f, 5.406f)
                ...
                curveTo(16f, 5.664f, 16.336f, 6f, 16.75f, 6f)
                lineTo(21.25f, 6f)
                close()
                moveTo(6f, 19.5f)
                lineTo(6f, 11f)
                lineTo(5.993f, 10.883f)
                curveTo(5.936f, 10.386f, 5.513f, 10f, 5f, 10f)
                curveTo(4.448f, 10f, 4f, 10.447f, 4f, 11f)
                lineTo(4f, 19.5f)
                lineTo(4.007f, 19.616f)
                curveTo(4.064f, 20.114f, 4.487f, 20.5f, 5f, 20.5f)
                curveTo(5.552f, 20.5f, 6f, 20.052f, 6f, 19.5f)
                close()
                moveTo(12.5f, 19.5f)
                lineTo(12.5f, 11f)
                lineTo(12.493f, 10.883f)
                curveTo(12.436f, 10.386f, 12.013f, 10f, 11.5f, 10f)
                curveTo(10.948f, 10f, 10.5f, 10.447f, 10.5f, 11f)
                lineTo(10.5f, 19.5f)
                lineTo(10.507f, 19.616f)
                curveTo(10.564f, 20.114f, 10.987f, 20.5f, 11.5f, 20.5f)
                curveTo(12.052f, 20.5f, 12.5f, 20.052f, 12.5f, 19.5f)
                close()
                moveTo(19f, 19.5f)
                verticalLineTo(11f)
                lineTo(18.993f, 10.883f)
                curveTo(18.935f, 10.386f, 18.513f, 10f, 18f, 10f)
                curveTo(17.448f, 10f, 17f, 10.447f, 17f, 11f)
                lineTo(17f, 19.5f)
                lineTo(17.007f, 19.616f)
                curveTo(17.065f, 20.114f, 17.487f, 20.5f, 18f, 20.5f)
                curveTo(18.552f, 20.5f, 19f, 20.052f, 19f, 19.5f)
                close()
                ...
                curveTo(12.38f, 7f, 11.92f, 6.729f, 11.58f, 6.394f)
                ...
                curveTo(11.064f, 3f, 11.703f, 3.984f, 12.087f, 4.575f)
                lineTo(12.126f, 4.635f)
                curveTo(12.332f, 4.953f, 12.472f, 5.168f, 12.631f, 5.325f)
                curveTo(12.767f, 5.459f, 12.869f, 5.5f, 13f, 5.5f)
                ...
                curveTo(2.158f, 3.881f, 2f, 4.37f, 2f, 5f)
                curveTo(2f, 5.639f, 2.181f, 6.196f, 2.54f, 6.601f)
                curveTo(2.9f, 7.009f, 3.397f, 7.212f, 3.899f, 7.196f)
                curveTo(4.315f, 7.182f, 4.695f, 7.029f, 5f, 6.77f)
                curveTo(5.305f, 7.029f, 5.685f, 7.182f, 6.101f, 7.196f)
                curveTo(6.603f, 7.212f, 7.1f, 7.009f, 7.46f, 6.601f)
                curveTo(7.819f, 6.196f, 8f, 5.639f, 8f, 5f)
                curveTo(8f, 4.37f, 7.842f, 3.881f, 7.671f, 3.54f)
                ...
                curveTo(6.408f, 4.369f, 6.5f, 4.63f, 6.5f, 5f)
                ...
                curveTo(5.842f, 5.484f, 5.75f, 5.31f, 5.75f, 5f)
                curveTo(5.75f, 4.586f, 5.414f, 4.25f, 5f, 4.25f)
                curveTo(4.586f, 4.25f, 4.25f, 4.586f, 4.25f, 5f)
...
@Preview
@Composable
private fun TextNumberListLtr90Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.TextNumberListLtr90, contentDescription = null)
    }
}
