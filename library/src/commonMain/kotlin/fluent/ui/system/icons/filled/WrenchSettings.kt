...
public val FluentIcons.Filled.WrenchSettings: ImageVector
    get() {
        if (_WrenchSettings != null) {
            return _WrenchSettings!!
        }
        _WrenchSettings = ImageVector.Builder(
            name = "Filled.WrenchSettings",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                ...
                curveTo(11.248f, 13.668f, 14.062f, 11f, 17.5f, 11f)
                curveTo(18.459f, 11f, 19.369f, 11.208f, 20.188f, 11.58f)
                curveTo(21.301f, 10.574f, 22f, 9.119f, 22f, 7.5f)
...
private fun WrenchSettingsPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.WrenchSettings, contentDescription = null)
    }
}
