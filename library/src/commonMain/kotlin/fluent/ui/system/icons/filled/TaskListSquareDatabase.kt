...
public val FluentUi.Filled.TaskListSquareDatabase: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun TaskListSquareDatabasePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.TaskListSquareDatabase, contentDescription = null)
    }
}
