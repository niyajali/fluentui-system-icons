...
public val FluentUi.Filled.TextSuperscript: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun TextSuperscriptPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.TextSuperscript, contentDescription = null)
    }
}
