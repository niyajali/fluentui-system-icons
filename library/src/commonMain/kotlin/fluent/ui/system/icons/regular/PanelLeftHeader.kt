...
public val FluentUi.Regular.PanelLeftHeader: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun PanelLeftHeaderPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.PanelLeftHeader, contentDescription = null)
    }
}
