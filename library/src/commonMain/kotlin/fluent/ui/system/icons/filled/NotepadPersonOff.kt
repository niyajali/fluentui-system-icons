...
public val FluentUi.Filled.NotepadPersonOff: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun NotepadPersonOffPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.NotepadPersonOff, contentDescription = null)
    }
}
