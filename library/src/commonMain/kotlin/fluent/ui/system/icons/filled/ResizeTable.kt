...
public val FluentUi.Filled.ResizeTable: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ResizeTablePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.ResizeTable, contentDescription = null)
    }
}
