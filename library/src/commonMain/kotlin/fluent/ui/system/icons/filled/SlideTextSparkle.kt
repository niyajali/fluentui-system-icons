...
public val FluentIcons.Filled.SlideTextSparkle: ImageVector
    get() {
        if (_SlideTextSparkle != null) {
            return _SlideTextSparkle!!
        }
        _SlideTextSparkle = ImageVector.Builder(
            name = "Filled.SlideTextSparkle",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
private var _SlideTextSparkle: ImageVector? = null

@Preview
@Composable
private fun SlideTextSparklePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.SlideTextSparkle, contentDescription = null)
    }
}
