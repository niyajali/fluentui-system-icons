...
public val FluentUi.Filled.ChatArrowBackDown: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ChatArrowBackDownPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.ChatArrowBackDown, contentDescription = null)
    }
}
