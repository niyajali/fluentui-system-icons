...
public val FluentUi.Regular.DocumentEndnote: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun DocumentEndnotePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.DocumentEndnote, contentDescription = null)
    }
}
