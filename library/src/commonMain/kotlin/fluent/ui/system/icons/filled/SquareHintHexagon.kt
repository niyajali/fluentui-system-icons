...
public val FluentUi.Filled.SquareHintHexagon: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun SquareHintHexagonPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.SquareHintHexagon, contentDescription = null)
    }
}
