...
public val FluentIcons.Regular.ContractUpRight: ImageVector
    get() {
        if (_ContractUpRight != null) {
            return _ContractUpRight!!
        }
        _ContractUpRight = ImageVector.Builder(
...
private var _ContractUpRight: ImageVector? = null

@Preview
@Composable
private fun ContractUpRightPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.ContractUpRight, contentDescription = null)
    }
}
