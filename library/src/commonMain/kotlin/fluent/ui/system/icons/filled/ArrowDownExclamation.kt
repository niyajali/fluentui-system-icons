...
public val FluentUi.Filled.ArrowDownExclamation: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ArrowDownExclamationPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.ArrowDownExclamation, contentDescription = null)
    }
}
