...
public val FluentUi.Filled.MoneyCalculator: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.MoneyCalculator",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color(0xFF212121))) {
            ...
            curveTo(5.493f, 8.5f, 6.5f, 7.493f, 6.5f, 6.25f)
            verticalLineTo(5.25f)
            horizontalLineTo(5f)
            verticalLineTo(6.25f)
            close()
            moveTo(10.5f, 12.5f)
            curveTo(11.743f, 12.5f, 12.75f, 11.493f, 12.75f, 10.25f)
            curveTo(12.75f, 9.007f, 11.743f, 8f, 10.5f, 8f)
            curveTo(9.257f, 8f, 8.25f, 9.007f, 8.25f, 10.25f)
            curveTo(8.25f, 11.493f, 9.257f, 12.5f, 10.5f, 12.5f)
            close()
            moveTo(4.25f, 13f)
            ...
            curveTo(6.5f, 12.507f, 5.493f, 11.5f, 4.25f, 11.5f)
            horizontalLineTo(3.25f)
            verticalLineTo(13f)
            horizontalLineTo(4.25f)
            close()
            ...
            verticalLineTo(6.25f)
            curveTo(14.5f, 7.493f, 15.507f, 8.5f, 16.75f, 8.5f)
            ...
            curveTo(21.397f, 6.92f, 22f, 7.89f, 22f, 9f)
            close()
            moveTo(16.5f, 12f)
...
private fun MoneyCalculatorPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.MoneyCalculator, contentDescription = null)
    }
}
