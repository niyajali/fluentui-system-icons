...
public val FluentIcons.Regular.FilmstripSplit: ImageVector
    get() {
        if (_FilmstripSplit != null) {
            return _FilmstripSplit!!
        }
        _FilmstripSplit = ImageVector.Builder(
            name = "Regular.FilmstripSplit",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
private var _FilmstripSplit: ImageVector? = null

@Preview
@Composable
private fun FilmstripSplitPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.FilmstripSplit, contentDescription = null)
    }
}
