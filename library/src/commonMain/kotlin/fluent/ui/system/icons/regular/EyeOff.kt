...
public val FluentUi.Regular.EyeOff: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        ...
        path(fill = SolidColor(Color(0xFF212121))) {
            ...
            lineTo(14.468f, 13.406f)
            lineTo(11.598f, 10.537f)
            ...
            close()
            moveTo(10.204f, 11.266f)
            lineTo(13.739f, 14.801f)
            curveTo(13.289f, 15.236f, 12.676f, 15.505f, 12f, 15.505f)
            curveTo(10.619f, 15.505f, 9.5f, 14.385f, 9.5f, 13.005f)
            curveTo(9.5f, 12.329f, 9.768f, 11.715f, 10.204f, 11.266f)
            close()
            moveTo(12f, 5.5f)
