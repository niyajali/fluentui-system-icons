...
public val FluentUi.Regular.PlayCircleHint: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun PlayCircleHintPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.PlayCircleHint, contentDescription = null)
    }
}
