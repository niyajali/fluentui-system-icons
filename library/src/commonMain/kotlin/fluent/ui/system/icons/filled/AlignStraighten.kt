...
public val FluentUi.Filled.AlignStraighten: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun AlignStraightenPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.AlignStraighten, contentDescription = null)
    }
}
