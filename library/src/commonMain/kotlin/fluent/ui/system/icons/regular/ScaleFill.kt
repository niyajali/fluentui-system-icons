...
public val FluentUi.Regular.ScaleFill: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ScaleFillPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.ScaleFill, contentDescription = null)
    }
}
