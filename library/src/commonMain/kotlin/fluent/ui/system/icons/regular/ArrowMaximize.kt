...
public val FluentUi.Regular.ArrowMaximize: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ArrowMaximizePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.ArrowMaximize, contentDescription = null)
    }
}
