...
public val FluentUi.Regular.PeopleCommunity: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun PeopleCommunityPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.PeopleCommunity, contentDescription = null)
    }
}
