...
public val FluentUi.Filled.TableResizeColumn: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun TableResizeColumnPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.TableResizeColumn, contentDescription = null)
    }
}
