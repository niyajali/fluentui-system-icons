...
public val FluentUi.Regular.PresenceUnknown: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun PresenceUnknownPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.PresenceUnknown, contentDescription = null)
    }
}
