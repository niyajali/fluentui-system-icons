...
public val FluentUi.Filled.FilmstripImage: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun FilmstripImagePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.FilmstripImage, contentDescription = null)
    }
}
