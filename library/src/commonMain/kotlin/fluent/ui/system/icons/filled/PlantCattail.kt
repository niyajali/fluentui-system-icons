...
public val FluentIcons.Filled.PlantCattail: ImageVector
    get() {
        if (_PlantCattail != null) {
            return _PlantCattail!!
        }
        _PlantCattail = ImageVector.Builder(
...
private var _PlantCattail: ImageVector? = null

@Preview
@Composable
private fun PlantCattailPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.PlantCattail, contentDescription = null)
    }
}
