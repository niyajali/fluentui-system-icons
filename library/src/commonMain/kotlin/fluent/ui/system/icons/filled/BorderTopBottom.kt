...
public val FluentUi.Filled.BorderTopBottom: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun BorderTopBottomPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.BorderTopBottom, contentDescription = null)
    }
}
