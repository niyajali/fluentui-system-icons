...
public val FluentUi.Filled.PanelLeftTextAdd: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun PanelLeftTextAddPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.PanelLeftTextAdd, contentDescription = null)
    }
}
