...
public val FluentUi.Regular.ArrowBetweenDown: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ArrowBetweenDownPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.ArrowBetweenDown, contentDescription = null)
    }
}
