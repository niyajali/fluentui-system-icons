...
public val FluentUi.Filled.TabInprivateAccount: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun TabInprivateAccountPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.TabInprivateAccount, contentDescription = null)
    }
}
