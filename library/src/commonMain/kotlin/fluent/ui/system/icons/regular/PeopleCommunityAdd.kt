...
public val FluentUi.Regular.PeopleCommunityAdd: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun PeopleCommunityAddPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.PeopleCommunityAdd, contentDescription = null)
    }
}
