...
public val FluentIcons.Filled.ProjectionScreenText: ImageVector
    get() {
        if (_ProjectionScreenText != null) {
            return _ProjectionScreenText!!
        }
        _ProjectionScreenText = ImageVector.Builder(
            name = "Filled.ProjectionScreenText",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                ...
                close()
                moveTo(9f, 7.75f)
                curveTo(9f, 8.164f, 9.336f, 8.5f, 9.75f, 8.5f)
...
private fun ProjectionScreenTextPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.ProjectionScreenText, contentDescription = null)
    }
}
