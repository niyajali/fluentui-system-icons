...
public val FluentIcons.Filled.TextAlignLeftRotate270: ImageVector
    get() {
        if (_TextAlignLeftRotate270 != null) {
            return _TextAlignLeftRotate270!!
        }
        _TextAlignLeftRotate270 = ImageVector.Builder(
...
private fun TextAlignLeftRotate270Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.TextAlignLeftRotate270, contentDescription = null)
    }
}
