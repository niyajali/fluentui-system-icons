...
public val FluentUi.Regular.TextBulletListSquareWarning: ImageVector by
...
private fun TextBulletListSquareWarningPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.TextBulletListSquareWarning, contentDescription = null)
    }
}
