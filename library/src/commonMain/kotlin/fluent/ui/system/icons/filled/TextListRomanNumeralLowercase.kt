...
public val FluentIcons.Filled.TextListRomanNumeralLowercase: ImageVector
    get() {
        if (_TextListRomanNumeralLowercase != null) {
            return _TextListRomanNumeralLowercase!!
        }
        _TextListRomanNumeralLowercase = ImageVector.Builder(
...
private var _TextListRomanNumeralLowercase: ImageVector? = null

@Preview
@Composable
private fun TextListRomanNumeralLowercasePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.TextListRomanNumeralLowercase, contentDescription = null)
    }
}
