...
public val FluentUi.Filled.SwimmingPool: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun SwimmingPoolPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.SwimmingPool, contentDescription = null)
    }
}
