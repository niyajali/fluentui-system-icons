...
public val FluentIcons.Regular.AccessibilityQuestionMark: ImageVector
    get() {
        if (_AccessibilityQuestionMark != null) {
            return _AccessibilityQuestionMark!!
        }
        _AccessibilityQuestionMark = ImageVector.Builder(
            name = "Regular.AccessibilityQuestionMark",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                ...
                curveTo(16.914f, 21.5f, 17.25f, 21.164f, 17.25f, 20.75f)
                curveTo(17.25f, 20.336f, 16.914f, 20f, 16.5f, 20f)
                ...
                curveTo(17.052f, 15f, 17.5f, 15.448f, 17.5f, 16f)
...
private var _AccessibilityQuestionMark: ImageVector? = null

@Preview
@Composable
private fun AccessibilityQuestionMarkPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.AccessibilityQuestionMark, contentDescription = null)
    }
}
