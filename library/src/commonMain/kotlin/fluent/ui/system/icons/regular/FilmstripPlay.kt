...
public val FluentIcons.Regular.FilmstripPlay: ImageVector
    get() {
        if (_FilmstripPlay != null) {
            return _FilmstripPlay!!
        }
        _FilmstripPlay = ImageVector.Builder(
...
private fun FilmstripPlayPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.FilmstripPlay, contentDescription = null)
    }
}
