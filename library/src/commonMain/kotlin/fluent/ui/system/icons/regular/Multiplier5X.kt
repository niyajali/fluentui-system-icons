...
public val FluentUi.Regular.Multiplier5X: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun Multiplier5XPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.Multiplier5X, contentDescription = null)
    }
}
