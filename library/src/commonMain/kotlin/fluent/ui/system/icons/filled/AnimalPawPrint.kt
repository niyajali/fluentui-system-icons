...
public val FluentIcons.Filled.AnimalPawPrint: ImageVector
    get() {
        if (_AnimalPawPrint != null) {
            return _AnimalPawPrint!!
        }
        _AnimalPawPrint = ImageVector.Builder(
            name = "Filled.AnimalPawPrint",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
private fun AnimalPawPrintPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.AnimalPawPrint, contentDescription = null)
    }
}
