...
public val FluentUi.Filled.AnimalPawPrint: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun AnimalPawPrintPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.AnimalPawPrint, contentDescription = null)
    }
}
