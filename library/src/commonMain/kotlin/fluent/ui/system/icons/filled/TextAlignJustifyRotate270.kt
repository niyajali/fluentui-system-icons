...
public val FluentIcons.Filled.TextAlignJustifyRotate270: ImageVector
    get() {
        if (_TextAlignJustifyRotate270 != null) {
            return _TextAlignJustifyRotate270!!
        }
        _TextAlignJustifyRotate270 = ImageVector.Builder(
            name = "Filled.TextAlignJustifyRotate270",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
private fun TextAlignJustifyRotate270Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.TextAlignJustifyRotate270, contentDescription = null)
    }
}
