...
public val FluentUi.Colored.BuildingStore: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun BuildingStorePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Colored.BuildingStore, contentDescription = null)
    }
}
