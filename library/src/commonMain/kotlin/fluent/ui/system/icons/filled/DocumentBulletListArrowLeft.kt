...
public val FluentIcons.Filled.DocumentBulletListArrowLeft: ImageVector
    get() {
        if (_DocumentBulletListArrowLeft != null) {
            return _DocumentBulletListArrowLeft!!
        }
        _DocumentBulletListArrowLeft = ImageVector.Builder(
...
private fun DocumentBulletListArrowLeftPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.DocumentBulletListArrowLeft, contentDescription = null)
    }
}
