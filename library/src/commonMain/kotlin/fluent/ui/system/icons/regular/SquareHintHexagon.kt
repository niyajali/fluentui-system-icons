...
public val FluentUi.Regular.SquareHintHexagon: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun SquareHintHexagonPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.SquareHintHexagon, contentDescription = null)
    }
}
