...
public val FluentUi.Filled.VehicleCar: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Filled.VehicleCar",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color(0xFF212121))) {
            moveTo(15.799f, 3f)
            curveTo(17.29f, 3f, 18.589f, 4.014f, 18.952f, 5.46f)
            lineTo(19.337f, 7f)
...
private fun VehicleCarPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.VehicleCar, contentDescription = null)
    }
}
