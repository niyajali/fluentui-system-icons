...
public val FluentUi.Filled.DataHistogram: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun DataHistogramPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.DataHistogram, contentDescription = null)
    }
}
