...
public val FluentUi.Filled.ExtendedDock: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ExtendedDockPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.ExtendedDock, contentDescription = null)
    }
}
