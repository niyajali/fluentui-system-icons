...
public val FluentUi.Filled.CardUiPortraitFlip: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun CardUiPortraitFlipPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.CardUiPortraitFlip, contentDescription = null)
    }
}
