...
public val FluentIcons.Filled.VideoClipWand: ImageVector
    get() {
        if (_VideoClipWand != null) {
            return _VideoClipWand!!
        }
        _VideoClipWand = ImageVector.Builder(
...
private fun VideoClipWandPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.VideoClipWand, contentDescription = null)
    }
}
