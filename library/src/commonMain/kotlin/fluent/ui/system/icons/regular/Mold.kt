...
public val FluentIcons.Regular.Mold: ImageVector
    get() {
        if (_Mold != null) {
            return _Mold!!
        }
        _Mold = ImageVector.Builder(
            name = "Regular.Mold",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                ...
                lineTo(13.482f, 6.361f)
                curveTo(14.63f, 5.212f, 16.493f, 5.212f, 17.642f, 6.361f)
                curveTo(18.79f, 7.51f, 18.79f, 9.372f, 17.642f, 10.521f)
                lineTo(10.523f, 17.639f)
                curveTo(9.374f, 18.788f, 7.512f, 18.788f, 6.363f, 17.639f)
                curveTo(5.214f, 16.491f, 5.214f, 14.628f, 6.363f, 13.48f)
                close()
                moveTo(9.5f, 15.5f)
                curveTo(9.5f, 16.052f, 9.052f, 16.5f, 8.5f, 16.5f)
                curveTo(7.948f, 16.5f, 7.5f, 16.052f, 7.5f, 15.5f)
                curveTo(7.5f, 14.948f, 7.948f, 14.5f, 8.5f, 14.5f)
                curveTo(9.052f, 14.5f, 9.5f, 14.948f, 9.5f, 15.5f)
                close()
                moveTo(15.5f, 9.5f)
                curveTo(16.052f, 9.5f, 16.5f, 9.052f, 16.5f, 8.5f)
                curveTo(16.5f, 7.948f, 16.052f, 7.5f, 15.5f, 7.5f)
                curveTo(14.948f, 7.5f, 14.5f, 7.948f, 14.5f, 8.5f)
                curveTo(14.5f, 9.052f, 14.948f, 9.5f, 15.5f, 9.5f)
                close()
            }
        }.build()
...
private var _Mold: ImageVector? = null

@Preview
@Composable
private fun MoldPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.Mold, contentDescription = null)
    }
}
