...
public val FluentIcons.Regular.DocumentBorderPrint: ImageVector
    get() {
        if (_DocumentBorderPrint != null) {
            return _DocumentBorderPrint!!
        }
        _DocumentBorderPrint = ImageVector.Builder(
...
private fun DocumentBorderPrintPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.DocumentBorderPrint, contentDescription = null)
    }
}
