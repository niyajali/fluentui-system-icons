...
public val FluentUi.Filled.NavigationBriefcase: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun NavigationBriefcasePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.NavigationBriefcase, contentDescription = null)
    }
}
