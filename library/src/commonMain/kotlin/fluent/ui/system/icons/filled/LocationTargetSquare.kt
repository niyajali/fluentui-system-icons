...
public val FluentUi.Filled.LocationTargetSquare: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun LocationTargetSquarePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.LocationTargetSquare, contentDescription = null)
    }
}
