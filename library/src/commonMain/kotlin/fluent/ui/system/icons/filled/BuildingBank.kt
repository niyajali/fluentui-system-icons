...
public val FluentUi.Filled.BuildingBank: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun BuildingBankPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.BuildingBank, contentDescription = null)
    }
}
