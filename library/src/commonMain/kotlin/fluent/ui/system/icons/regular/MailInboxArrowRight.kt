...
public val FluentUi.Regular.MailInboxArrowRight: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun MailInboxArrowRightPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.MailInboxArrowRight, contentDescription = null)
    }
}
