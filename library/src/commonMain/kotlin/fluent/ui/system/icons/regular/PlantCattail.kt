...
public val FluentUi.Regular.PlantCattail: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun PlantCattailPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.PlantCattail, contentDescription = null)
    }
}
