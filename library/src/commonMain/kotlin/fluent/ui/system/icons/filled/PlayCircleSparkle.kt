...
public val FluentUi.Filled.PlayCircleSparkle: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun PlayCircleSparklePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.PlayCircleSparkle, contentDescription = null)
    }
}
