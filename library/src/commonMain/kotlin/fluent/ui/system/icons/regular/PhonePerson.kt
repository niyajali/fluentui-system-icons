...
public val FluentIcons.Regular.PhonePerson: ImageVector
    get() {
        if (_PhonePerson != null) {
            return _PhonePerson!!
        }
        _PhonePerson = ImageVector.Builder(
...
private var _PhonePerson: ImageVector? = null

@Preview
@Composable
private fun PhonePersonPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.PhonePerson, contentDescription = null)
    }
}
