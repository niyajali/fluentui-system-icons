...
public val FluentIcons.Filled.VideoBluetooth: ImageVector
    get() {
        if (_VideoBluetooth != null) {
            return _VideoBluetooth!!
        }
        _VideoBluetooth = ImageVector.Builder(
...
private fun VideoBluetoothPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.VideoBluetooth, contentDescription = null)
    }
}
