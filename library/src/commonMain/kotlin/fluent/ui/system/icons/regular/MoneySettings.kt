...
public val FluentIcons.Regular.MoneySettings: ImageVector
    get() {
        if (_MoneySettings != null) {
            return _MoneySettings!!
        }
        _MoneySettings = ImageVector.Builder(
            name = "Regular.MoneySettings",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
private fun MoneySettingsPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.MoneySettings, contentDescription = null)
    }
}
