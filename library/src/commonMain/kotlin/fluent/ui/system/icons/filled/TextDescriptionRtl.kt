...
public val FluentIcons.Filled.TextDescriptionRtl: ImageVector
    get() {
        if (_TextDescriptionRtl != null) {
            return _TextDescriptionRtl!!
        }
        _TextDescriptionRtl = ImageVector.Builder(
...
private fun TextDescriptionRtlPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.TextDescriptionRtl, contentDescription = null)
    }
}
