...
public val FluentUi.Regular.GiftCardAdd: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun GiftCardAddPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.GiftCardAdd, contentDescription = null)
    }
}
