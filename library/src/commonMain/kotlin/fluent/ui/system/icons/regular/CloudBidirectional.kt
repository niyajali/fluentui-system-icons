...
public val FluentUi.Regular.CloudBidirectional: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun CloudBidirectionalPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.CloudBidirectional, contentDescription = null)
    }
}
