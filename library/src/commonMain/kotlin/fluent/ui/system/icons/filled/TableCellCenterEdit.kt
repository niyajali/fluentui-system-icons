...
public val FluentUi.Filled.TableCellCenterEdit: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun TableCellCenterEditPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.TableCellCenterEdit, contentDescription = null)
    }
}
