...
public val FluentIcons.Filled.DocumentBulletListCube: ImageVector
    get() {
        if (_DocumentBulletListCube != null) {
            return _DocumentBulletListCube!!
        }
        _DocumentBulletListCube = ImageVector.Builder(
            name = "Filled.DocumentBulletListCube",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                ...
                curveTo(17f, 17.836f, 16.664f, 17.5f, 16.25f, 17.5f)
                horizontalLineTo(12f)
                verticalLineTo(16f)
                horizontalLineTo(16.25f)
                curveTo(16.664f, 16f, 17f, 15.664f, 17f, 15.25f)
                curveTo(17f, 14.836f, 16.664f, 14.5f, 16.25f, 14.5f)
                horizontalLineTo(11.885f)
                curveTo(11.685f, 13.863f, 11.234f, 13.322f, 10.618f, 13.014f)
                lineTo(10.515f, 12.962f)
                curveTo(10.589f, 12.987f, 10.668f, 13f, 10.75f, 13f)
                horizontalLineTo(16.25f)
                ...
                curveTo(10f, 12.505f, 10.127f, 12.73f, 10.322f, 12.866f)
...
@Preview
@Composable
private fun DocumentBulletListCubePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.DocumentBulletListCube, contentDescription = null)
    }
}
