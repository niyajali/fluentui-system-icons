...
public val FluentIcons.Filled.SearchSparkle: ImageVector
    get() {
        if (_SearchSparkle != null) {
            return _SearchSparkle!!
        }
        _SearchSparkle = ImageVector.Builder(
            name = "Filled.SearchSparkle",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                ...
                close()
                moveTo(16.271f, 14.967f)
                curveTo(16.682f, 14.45f, 17.03f, 13.88f, 17.303f, 13.27f)
                curveTo(17.174f, 13.013f, 17.082f, 12.721f, 16.994f, 12.444f)
                lineTo(16.98f, 12.399f)
                curveTo(16.864f, 12.046f, 16.434f, 11.936f, 16.074f, 11.845f)
                curveTo(15.987f, 11.823f, 15.903f, 11.802f, 15.83f, 11.779f)
                curveTo(15.8f, 11.768f, 15.771f, 11.757f, 15.743f, 11.744f)
                curveTo(14.996f, 14.207f, 12.707f, 16f, 10f, 16f)
                curveTo(6.686f, 16f, 4f, 13.314f, 4f, 10f)
                curveTo(4f, 7.009f, 6.189f, 4.529f, 9.052f, 4.075f)
                curveTo(9.183f, 3.581f, 9.552f, 3.177f, 10.05f, 2.999f)
                lineTo(11.39f, 2.559f)
                curveTo(11.598f, 2.489f, 11.792f, 2.381f, 11.962f, 2.242f)
                curveTo(11.334f, 2.084f, 10.677f, 2f, 10f, 2f)
                curveTo(5.582f, 2f, 2f, 5.582f, 2f, 10f)
                curveTo(2f, 14.418f, 5.582f, 18f, 10f, 18f)
                curveTo(11.82f, 18f, 13.499f, 17.392f, 14.843f, 16.368f)
                lineTo(19.302f, 20.716f)
                curveTo(19.697f, 21.101f, 20.33f, 21.094f, 20.716f, 20.698f)
                curveTo(21.101f, 20.303f, 21.094f, 19.67f, 20.698f, 19.284f)
                lineTo(16.271f, 14.967f)
                close()
            }
        }.build()
...
private var _SearchSparkle: ImageVector? = null

@Preview
@Composable
private fun SearchSparklePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.SearchSparkle, contentDescription = null)
    }
}
