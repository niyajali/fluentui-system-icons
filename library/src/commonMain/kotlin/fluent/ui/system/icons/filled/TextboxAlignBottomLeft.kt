...
public val FluentUi.Filled.TextboxAlignBottomLeft: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun TextboxAlignBottomLeftPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.TextboxAlignBottomLeft, contentDescription = null)
    }
}
