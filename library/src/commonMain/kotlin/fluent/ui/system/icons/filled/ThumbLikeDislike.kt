...
public val FluentIcons.Filled.ThumbLikeDislike: ImageVector
    get() {
        if (_ThumbLikeDislike != null) {
            return _ThumbLikeDislike!!
        }
        _ThumbLikeDislike = ImageVector.Builder(
...
private fun ThumbLikeDislikePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.ThumbLikeDislike, contentDescription = null)
    }
}
