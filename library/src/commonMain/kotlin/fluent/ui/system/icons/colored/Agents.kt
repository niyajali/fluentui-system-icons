...
public val FluentIcons.Colored.Agents: ImageVector
    get() {
        if (_Agents != null) {
            return _Agents!!
        }
        _Agents = ImageVector.Builder(
            name = "Colored.Agents",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _Agents: ImageVector? = null

@Preview
@Composable
private fun AgentsPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Colored.Agents, contentDescription = null)
    }
}
