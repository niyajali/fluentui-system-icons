...
public val FluentUi.Regular.ShieldKeyhole: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ShieldKeyholePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.ShieldKeyhole, contentDescription = null)
    }
}
