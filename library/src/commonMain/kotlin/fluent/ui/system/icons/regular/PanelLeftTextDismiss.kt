...
public val FluentIcons.Regular.PanelLeftTextDismiss: ImageVector
    get() {
        if (_PanelLeftTextDismiss != null) {
            return _PanelLeftTextDismiss!!
        }
        _PanelLeftTextDismiss = ImageVector.Builder(
            name = "Regular.PanelLeftTextDismiss",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
private var _PanelLeftTextDismiss: ImageVector? = null

@Preview
@Composable
private fun PanelLeftTextDismissPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.PanelLeftTextDismiss, contentDescription = null)
    }
}
