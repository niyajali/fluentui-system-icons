...
public val FluentIcons.Filled.TableOffsetLessThanOrEqualTo: ImageVector
    get() {
        if (_TableOffsetLessThanOrEqualTo != null) {
            return _TableOffsetLessThanOrEqualTo!!
        }
        _TableOffsetLessThanOrEqualTo = ImageVector.Builder(
...
private fun TableOffsetLessThanOrEqualToPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.TableOffsetLessThanOrEqualTo, contentDescription = null)
    }
}
