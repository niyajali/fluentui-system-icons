...
public val FluentUi.Filled.WeatherMoon: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun WeatherMoonPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.WeatherMoon, contentDescription = null)
    }
}
