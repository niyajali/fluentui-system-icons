...
public val FluentUi.Regular.PeopleTeamDelete: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun PeopleTeamDeletePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.PeopleTeamDelete, contentDescription = null)
    }
}
