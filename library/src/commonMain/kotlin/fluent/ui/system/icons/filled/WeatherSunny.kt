...
public val FluentUi.Filled.WeatherSunny: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun WeatherSunnyPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.WeatherSunny, contentDescription = null)
    }
}
