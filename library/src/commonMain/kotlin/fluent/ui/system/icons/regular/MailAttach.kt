...
public val FluentUi.Regular.MailAttach: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun MailAttachPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.MailAttach, contentDescription = null)
    }
}
