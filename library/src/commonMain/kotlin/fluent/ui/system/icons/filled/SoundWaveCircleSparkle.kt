...
public val FluentIcons.Filled.SoundWaveCircleSparkle: ImageVector
    get() {
        if (_SoundWaveCircleSparkle != null) {
            return _SoundWaveCircleSparkle!!
        }
        _SoundWaveCircleSparkle = ImageVector.Builder(
            name = "Filled.SoundWaveCircleSparkle",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                ...
                close()
                moveTo(12f, 2f)
                curveTo(12.957f, 2f, 13.883f, 2.135f, 14.76f, 2.386f)
                curveTo(14.644f, 2.457f, 14.52f, 2.516f, 14.39f, 2.559f)
                lineTo(13.05f, 2.999f)
                curveTo(12.425f, 3.222f, 12.002f, 3.803f, 12f, 4.469f)
                curveTo(12.002f, 5.104f, 12.416f, 5.746f, 13f, 5.999f)
                lineTo(14.4f, 6.459f)
                curveTo(14.916f, 6.634f, 15.414f, 7.025f, 15.59f, 7.549f)
                lineTo(15.767f, 8.176f)
                ...
                curveTo(17.146f, 10.023f, 17.301f, 10.049f, 17.46f, 10.049f)
                curveTo(17.696f, 10.052f, 17.93f, 9.997f, 18.14f, 9.889f)
                curveTo(18.021f, 10.089f, 17.959f, 10.317f, 17.96f, 10.549f)
                curveTo(17.956f, 11.089f, 18.322f, 11.597f, 18.83f, 11.779f)
                curveTo(18.903f, 11.802f, 18.986f, 11.823f, 19.074f, 11.845f)
...
private var _SoundWaveCircleSparkle: ImageVector? = null

@Preview
@Composable
private fun SoundWaveCircleSparklePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.SoundWaveCircleSparkle, contentDescription = null)
    }
}
