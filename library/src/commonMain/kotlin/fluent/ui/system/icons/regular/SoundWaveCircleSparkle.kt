    ...
    get() {
        ...
        _SoundWaveCircleSparkle = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                ...
                curveTo(12.763f, 3.102f, 12.518f, 3.28f, 12.337f, 3.507f)
                curveTo(12.226f, 3.502f, 12.113f, 3.5f, 12f, 3.5f)
                curveTo(7.306f, 3.5f, 3.5f, 7.306f, 3.5f, 12f)
                curveTo(3.5f, 16.694f, 7.306f, 20.5f, 12f, 20.5f)
                curveTo(16.212f, 20.5f, 19.709f, 17.436f, 20.383f, 13.415f)
                ...
                close()
                moveTo(15.5f, 8.75f)
                curveTo(15.5f, 8.52f, 15.604f, 8.314f, 15.767f, 8.176f)
                lineTo(16f, 8.999f)
                curveTo(16.162f, 9.472f, 16.539f, 9.83f, 17f, 9.977f)
...
private fun SoundWaveCircleSparklePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.SoundWaveCircleSparkle, contentDescription = null)
    }
}
