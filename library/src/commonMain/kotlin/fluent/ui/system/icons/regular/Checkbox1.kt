...
public val FluentUi.Regular.Checkbox1: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun Checkbox1Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.Checkbox1, contentDescription = null)
    }
}
