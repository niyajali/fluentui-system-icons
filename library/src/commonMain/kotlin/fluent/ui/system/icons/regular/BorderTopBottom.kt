...
public val FluentUi.Regular.BorderTopBottom: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun BorderTopBottomPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.BorderTopBottom, contentDescription = null)
    }
}
