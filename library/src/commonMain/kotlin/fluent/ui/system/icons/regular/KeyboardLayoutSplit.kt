...
public val FluentUi.Regular.KeyboardLayoutSplit: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun KeyboardLayoutSplitPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.KeyboardLayoutSplit, contentDescription = null)
    }
}
