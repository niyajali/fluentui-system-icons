...
public val FluentUi.Filled.VideoPersonStarOff: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun VideoPersonStarOffPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.VideoPersonStarOff, contentDescription = null)
    }
}
