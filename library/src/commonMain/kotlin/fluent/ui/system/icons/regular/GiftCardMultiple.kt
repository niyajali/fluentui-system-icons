...
public val FluentUi.Regular.GiftCardMultiple: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        ...
        path(fill = SolidColor(Color(0xFF212121))) {
            ...
            curveTo(2f, 16.157f, 3.343f, 17.5f, 5f, 17.5f)
            ...
            verticalLineTo(5.5f)
            horizontalLineTo(16.5f)
            curveTo(17.328f, 5.5f, 18f, 6.172f, 18f, 7f)
            verticalLineTo(10f)
            ...
            close()
            moveTo(10.561f, 11.5f)
            horizontalLineTo(18f)
            verticalLineTo(14.5f)
            curveTo(18f, 15.328f, 17.328f, 16f, 16.5f, 16f)
            ...
            verticalLineTo(16f)
            horizontalLineTo(5f)
            curveTo(4.172f, 16f, 3.5f, 15.328f, 3.5f, 14.5f)
            ...
            close()
            moveTo(7f, 8f)
            curveTo(7.551f, 8f, 7.998f, 8.445f, 8f, 8.996f)
            verticalLineTo(10f)
            horizontalLineTo(7f)
