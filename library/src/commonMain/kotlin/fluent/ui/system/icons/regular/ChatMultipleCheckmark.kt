...
public val FluentUi.Regular.ChatMultipleCheckmark: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ChatMultipleCheckmarkPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.ChatMultipleCheckmark, contentDescription = null)
    }
}
