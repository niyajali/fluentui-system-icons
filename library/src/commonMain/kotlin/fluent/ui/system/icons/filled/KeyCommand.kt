...
public val FluentUi.Filled.KeyCommand: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun KeyCommandPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.KeyCommand, contentDescription = null)
    }
}
