...
public val FluentUi.Regular.ColumnTriple: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ColumnTriplePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.ColumnTriple, contentDescription = null)
    }
}
