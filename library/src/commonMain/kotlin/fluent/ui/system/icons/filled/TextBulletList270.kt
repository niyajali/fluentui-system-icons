...
public val FluentUi.Filled.TextBulletList270: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun TextBulletList270Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.TextBulletList270, contentDescription = null)
    }
}
