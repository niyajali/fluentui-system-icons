...
public val FluentUi.Filled.PhoneVerticalScroll: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun PhoneVerticalScrollPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.PhoneVerticalScroll, contentDescription = null)
    }
}
