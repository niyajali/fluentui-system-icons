...
public val FluentUi.Filled.PaintBrushSparkle: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun PaintBrushSparklePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.PaintBrushSparkle, contentDescription = null)
    }
}
