...
public val FluentUi.Regular.Dishwasher: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun DishwasherPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.Dishwasher, contentDescription = null)
    }
}
