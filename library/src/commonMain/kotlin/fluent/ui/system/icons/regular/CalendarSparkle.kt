...
public val FluentIcons.Regular.CalendarSparkle: ImageVector
    get() {
        if (_CalendarSparkle != null) {
            return _CalendarSparkle!!
        }
        _CalendarSparkle = ImageVector.Builder(
            name = "Regular.CalendarSparkle",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                ...
                curveTo(11f, 4.479f, 11f, 4.49f, 11f, 4.5f)
                horizontalLineTo(6.25f)
                curveTo(5.284f, 4.5f, 4.5f, 5.284f, 4.5f, 6.25f)
                verticalLineTo(7f)
                horizontalLineTo(14.254f)
                curveTo(14.403f, 7.159f, 14.521f, 7.344f, 14.59f, 7.549f)
                lineTo(14.859f, 8.5f)
                ...
                verticalLineTo(13.587f)
                curveTo(19.714f, 13.863f, 20.012f, 14.05f, 20.46f, 14.05f)
                curveTo(20.671f, 14.05f, 20.849f, 14.008f, 21f, 13.936f)
                verticalLineTo(17.75f)
...
private fun CalendarSparklePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.CalendarSparkle, contentDescription = null)
    }
}
