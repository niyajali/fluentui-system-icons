...
public val FluentUi.Regular.BroadActivityFeed: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun BroadActivityFeedPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.BroadActivityFeed, contentDescription = null)
    }
}
