...
public val FluentIcons.Regular.PlayCircleSparkle: ImageVector
    get() {
        if (_PlayCircleSparkle != null) {
            return _PlayCircleSparkle!!
        }
        _PlayCircleSparkle = ImageVector.Builder(
            name = "Regular.PlayCircleSparkle",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
private fun PlayCircleSparklePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.PlayCircleSparkle, contentDescription = null)
    }
}
