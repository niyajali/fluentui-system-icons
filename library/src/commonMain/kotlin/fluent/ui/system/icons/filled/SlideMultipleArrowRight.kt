...
public val FluentUi.Filled.SlideMultipleArrowRight: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun SlideMultipleArrowRightPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.SlideMultipleArrowRight, contentDescription = null)
    }
}
