...
public val FluentUi.Regular.DualScreenSpan: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun DualScreenSpanPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.DualScreenSpan, contentDescription = null)
    }
}
