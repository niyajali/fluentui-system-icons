...
public val FluentUi.Filled.CalendarAssistant: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun CalendarAssistantPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.CalendarAssistant, contentDescription = null)
    }
}
