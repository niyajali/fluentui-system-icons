...
public val FluentIcons.Filled.ArrowFlowUpRight: ImageVector
    get() {
        if (_ArrowFlowUpRight != null) {
            return _ArrowFlowUpRight!!
        }
        _ArrowFlowUpRight = ImageVector.Builder(
            name = "Filled.ArrowFlowUpRight",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
private var _ArrowFlowUpRight: ImageVector? = null

@Preview
@Composable
private fun ArrowFlowUpRightPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.ArrowFlowUpRight, contentDescription = null)
    }
}
