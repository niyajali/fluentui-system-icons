...
public val FluentUi.Filled.VideoSecurity: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun VideoSecurityPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.VideoSecurity, contentDescription = null)
    }
}
