...
public val FluentUi.Regular.ShoppingBagPlay: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ShoppingBagPlayPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.ShoppingBagPlay, contentDescription = null)
    }
}
