...
public val FluentUi.Filled.PlugConnectedSettings: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun PlugConnectedSettingsPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.PlugConnectedSettings, contentDescription = null)
    }
}
