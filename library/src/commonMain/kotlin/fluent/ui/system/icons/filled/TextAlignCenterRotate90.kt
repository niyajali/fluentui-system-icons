...
public val FluentIcons.Filled.TextAlignCenterRotate90: ImageVector
    get() {
        if (_TextAlignCenterRotate90 != null) {
            return _TextAlignCenterRotate90!!
        }
        _TextAlignCenterRotate90 = ImageVector.Builder(
...
private fun TextAlignCenterRotate90Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.TextAlignCenterRotate90, contentDescription = null)
    }
}
