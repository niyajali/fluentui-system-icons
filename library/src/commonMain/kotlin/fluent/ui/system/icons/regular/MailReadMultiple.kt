...
public val FluentIcons.Regular.MailReadMultiple: ImageVector
    get() {
        if (_MailReadMultiple != null) {
            return _MailReadMultiple!!
        }
        _MailReadMultiple = ImageVector.Builder(
            name = "Regular.MailReadMultiple",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
private fun MailReadMultiplePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.MailReadMultiple, contentDescription = null)
    }
}
