...
public val FluentUi.Filled.HapticStrong: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun HapticStrongPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.HapticStrong, contentDescription = null)
    }
}
