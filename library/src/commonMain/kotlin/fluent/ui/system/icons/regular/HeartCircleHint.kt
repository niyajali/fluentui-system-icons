...
public val FluentUi.Regular.HeartCircleHint: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun HeartCircleHintPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.HeartCircleHint, contentDescription = null)
    }
}
