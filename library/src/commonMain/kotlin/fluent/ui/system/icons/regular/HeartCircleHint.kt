...
public val FluentIcons.Regular.HeartCircleHint: ImageVector
    get() {
        if (_HeartCircleHint != null) {
            return _HeartCircleHint!!
        }
        _HeartCircleHint = ImageVector.Builder(
            name = "Regular.HeartCircleHint",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                ...
                close()
                moveTo(13.522f, 9.844f)
                curveTo(13.994f, 9.366f, 14.773f, 9.39f, 15.214f, 9.897f)
                curveTo(15.591f, 10.331f, 15.591f, 10.976f, 15.214f, 11.41f)
                lineTo(11.999f, 15.109f)
                lineTo(8.784f, 11.41f)
                curveTo(8.407f, 10.976f, 8.407f, 10.331f, 8.784f, 9.897f)
                curveTo(9.225f, 9.39f, 10.004f, 9.366f, 10.476f, 9.844f)
                lineTo(11.465f, 10.846f)
                curveTo(11.606f, 10.989f, 11.798f, 11.069f, 11.999f, 11.069f)
                curveTo(12.199f, 11.069f, 12.392f, 10.989f, 12.533f, 10.846f)
                lineTo(13.522f, 9.844f)
                close()
                moveTo(16.346f, 8.913f)
                curveTo(15.332f, 7.747f, 13.54f, 7.69f, 12.455f, 8.79f)
                lineTo(11.999f, 9.252f)
                lineTo(11.543f, 8.79f)
                curveTo(10.457f, 7.69f, 8.666f, 7.747f, 7.652f, 8.913f)
                curveTo(6.784f, 9.911f, 6.784f, 11.396f, 7.652f, 12.394f)
                lineTo(11.433f, 16.744f)
                curveTo(11.575f, 16.908f, 11.782f, 17.003f, 11.999f, 17.003f)
                curveTo(12.216f, 17.003f, 12.422f, 16.908f, 12.565f, 16.744f)
                lineTo(16.346f, 12.394f)
                curveTo(17.213f, 11.396f, 17.213f, 9.911f, 16.346f, 8.913f)
                close()
            }
        }.build()
...
private fun HeartCircleHintPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.HeartCircleHint, contentDescription = null)
    }
}
