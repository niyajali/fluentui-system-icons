...
public val FluentIcons.Filled.XboxControllerError: ImageVector
    get() {
        if (_XboxControllerError != null) {
            return _XboxControllerError!!
        }
        _XboxControllerError = ImageVector.Builder(
...
private fun XboxControllerErrorPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.XboxControllerError, contentDescription = null)
    }
}
