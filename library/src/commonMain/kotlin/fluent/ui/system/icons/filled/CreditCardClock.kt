...
public val FluentUi.Filled.CreditCardClock: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun CreditCardClockPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.CreditCardClock, contentDescription = null)
    }
}
