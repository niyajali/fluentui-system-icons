...
public val FluentUi.Regular.CallRectangleLandscape: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun CallRectangleLandscapePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.CallRectangleLandscape, contentDescription = null)
    }
}
