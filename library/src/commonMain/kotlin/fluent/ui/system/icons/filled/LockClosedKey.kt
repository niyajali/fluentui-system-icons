...
public val FluentIcons.Filled.LockClosedKey: ImageVector
    get() {
        if (_LockClosedKey != null) {
            return _LockClosedKey!!
        }
        _LockClosedKey = ImageVector.Builder(
            name = "Filled.LockClosedKey",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                ...
                curveTo(15.011f, 15.871f, 15f, 15.687f, 15f, 15.5f)
                curveTo(15f, 13.015f, 17.015f, 11f, 19.5f, 11f)
...
private var _LockClosedKey: ImageVector? = null

@Preview
@Composable
private fun LockClosedKeyPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.LockClosedKey, contentDescription = null)
    }
}
