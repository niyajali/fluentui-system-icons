...
public val FluentUi.Filled.LockClosedKey: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun LockClosedKeyPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.LockClosedKey, contentDescription = null)
    }
}
