...
public val FluentUi.Regular.CheckboxChecked: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun CheckboxCheckedPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.CheckboxChecked, contentDescription = null)
    }
}
