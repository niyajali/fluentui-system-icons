...
public val FluentUi.Regular.PhoneTablet: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun PhoneTabletPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.PhoneTablet, contentDescription = null)
    }
}
