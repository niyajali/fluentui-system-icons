...
public val FluentIcons.Filled.GlobeProhibited: ImageVector
    get() {
        if (_GlobeProhibited != null) {
            return _GlobeProhibited!!
        }
        _GlobeProhibited = ImageVector.Builder(
            name = "Filled.GlobeProhibited",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
private fun GlobeProhibitedPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.GlobeProhibited, contentDescription = null)
    }
}
