...
public val FluentIcons.Filled.TableColumnTopBottomLink: ImageVector
    get() {
        if (_TableColumnTopBottomLink != null) {
            return _TableColumnTopBottomLink!!
        }
        _TableColumnTopBottomLink = ImageVector.Builder(
            name = "Filled.TableColumnTopBottomLink",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
private var _TableColumnTopBottomLink: ImageVector? = null

@Preview
@Composable
private fun TableColumnTopBottomLinkPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.TableColumnTopBottomLink, contentDescription = null)
    }
}
