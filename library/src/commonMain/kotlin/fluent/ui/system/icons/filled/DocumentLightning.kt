...
public val FluentIcons.Filled.DocumentLightning: ImageVector
    get() {
        if (_DocumentLightning != null) {
            return _DocumentLightning!!
        }
        _DocumentLightning = ImageVector.Builder(
...
private var _DocumentLightning: ImageVector? = null

@Preview
@Composable
private fun DocumentLightningPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.DocumentLightning, contentDescription = null)
    }
}
