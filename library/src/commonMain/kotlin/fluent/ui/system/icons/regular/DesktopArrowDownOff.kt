...
public val FluentUi.Regular.DesktopArrowDownOff: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun DesktopArrowDownOffPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.DesktopArrowDownOff, contentDescription = null)
    }
}
