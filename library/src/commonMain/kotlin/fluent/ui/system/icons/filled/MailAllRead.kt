...
public val FluentUi.Filled.MailAllRead: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun MailAllReadPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.MailAllRead, contentDescription = null)
    }
}
