...
public val FluentIcons.Filled.VehicleCarParking: ImageVector
    get() {
        if (_VehicleCarParking != null) {
            return _VehicleCarParking!!
        }
        _VehicleCarParking = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                moveTo(17.25f, 2f)
                curveTo(17.25f, 1.448f, 17.698f, 1f, 18.25f, 1f)
                horizontalLineTo(22f)
                curveTo(22.552f, 1f, 23f, 1.448f, 23f, 2f)
                verticalLineTo(7f)
                curveTo(23f, 7.552f, 22.552f, 8f, 22f, 8f)
                horizontalLineTo(21f)
                verticalLineTo(22.25f)
                curveTo(21f, 22.664f, 20.664f, 23f, 20.25f, 23f)
                curveTo(19.836f, 23f, 19.5f, 22.664f, 19.5f, 22.25f)
                verticalLineTo(8f)
                ...
                close()
                moveTo(15.799f, 3f)
                curveTo(15.952f, 3f, 16.102f, 3.011f, 16.25f, 3.031f)
                ...
                curveTo(16.784f, 21.497f, 16f, 20.713f, 16f, 19.747f)
                lineTo(15.999f, 18.5f)
                horizontalLineTo(8.004f)
                lineTo(8.004f, 19.747f)
                curveTo(8.004f, 20.713f, 7.221f, 21.497f, 6.254f, 21.497f)
                horizontalLineTo(4.75f)
                curveTo(3.783f, 21.497f, 3f, 20.713f, 3f, 19.747f)
                verticalLineTo(11.25f)
                curveTo(3f, 10.435f, 3.433f, 9.721f, 4.082f, 9.327f)
                lineTo(4.289f, 8.5f)
                horizontalLineTo(3.75f)
                curveTo(3.37f, 8.5f, 3.057f, 8.218f, 3.007f, 7.852f)
                lineTo(3f, 7.75f)
                curveTo(3f, 7.37f, 3.282f, 7.057f, 3.648f, 7.007f)
                lineTo(3.75f, 7f)
                ...
                lineTo(10.147f, 14.007f)
                curveTo(9.781f, 14.057f, 9.499f, 14.37f, 9.499f, 14.75f)
                curveTo(9.499f, 15.13f, 9.781f, 15.443f, 10.147f, 15.493f)
                lineTo(10.249f, 15.5f)
                horizontalLineTo(13.751f)
                lineTo(13.852f, 15.493f)
                curveTo(14.219f, 15.443f, 14.501f, 15.13f, 14.501f, 14.75f)
                curveTo(14.501f, 14.336f, 14.165f, 14f, 13.751f, 14f)
                close()
                moveTo(17f, 12f)
                curveTo(16.448f, 12f, 16f, 12.448f, 16f, 13f)
                curveTo(16f, 13.552f, 16.448f, 14f, 17f, 14f)
...
private fun VehicleCarParkingPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.VehicleCarParking, contentDescription = null)
    }
}
