...
public val FluentIcons.Filled.VehicleCarProfileLtrClock: ImageVector
    get() {
        if (_VehicleCarProfileLtrClock != null) {
            return _VehicleCarProfileLtrClock!!
        }
        _VehicleCarProfileLtrClock = ImageVector.Builder(
...
private fun VehicleCarProfileLtrClockPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.VehicleCarProfileLtrClock, contentDescription = null)
    }
}
