...
public val FluentUi.Filled.ArrowAutofitHeightIn: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ArrowAutofitHeightInPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.ArrowAutofitHeightIn, contentDescription = null)
    }
}
