...
public val FluentUi.Regular.Multiplier2X: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun Multiplier2XPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.Multiplier2X, contentDescription = null)
    }
}
