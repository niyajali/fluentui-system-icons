...
public val FluentUi.Regular.CursorHover: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun CursorHoverPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.CursorHover, contentDescription = null)
    }
}
