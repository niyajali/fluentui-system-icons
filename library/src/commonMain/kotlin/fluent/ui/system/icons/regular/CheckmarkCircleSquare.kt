...
public val FluentUi.Regular.CheckmarkCircleSquare: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun CheckmarkCircleSquarePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.CheckmarkCircleSquare, contentDescription = null)
    }
}
