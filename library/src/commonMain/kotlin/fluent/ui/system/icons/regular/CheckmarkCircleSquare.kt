...
public val FluentIcons.Regular.CheckmarkCircleSquare: ImageVector
    get() {
        if (_CheckmarkCircleSquare != null) {
            return _CheckmarkCircleSquare!!
        }
        _CheckmarkCircleSquare = ImageVector.Builder(
            name = "Regular.CheckmarkCircleSquare",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                moveTo(14.5f, 8.5f)
                curveTo(14.5f, 5.186f, 11.814f, 2.5f, 8.5f, 2.5f)
                curveTo(5.186f, 2.5f, 2.5f, 5.186f, 2.5f, 8.5f)
                curveTo(2.5f, 11.814f, 5.186f, 14.5f, 8.5f, 14.5f)
                curveTo(11.814f, 14.5f, 14.5f, 11.814f, 14.5f, 8.5f)
                close()
                moveTo(16f, 8.5f)
                ...
                close()
                moveTo(20.28f, 14.78f)
                curveTo(20.573f, 14.487f, 20.573f, 14.013f, 20.28f, 13.72f)
                curveTo(19.987f, 13.427f, 19.513f, 13.427f, 19.22f, 13.72f)
                lineTo(15.75f, 17.189f)
                lineTo(14.28f, 15.72f)
                curveTo(13.987f, 15.427f, 13.513f, 15.427f, 13.22f, 15.72f)
                curveTo(12.927f, 16.013f, 12.927f, 16.487f, 13.22f, 16.78f)
                lineTo(15.22f, 18.78f)
                curveTo(15.513f, 19.073f, 15.987f, 19.073f, 16.28f, 18.78f)
                lineTo(20.28f, 14.78f)
                close()
                moveTo(12.28f, 5.72f)
...
private var _CheckmarkCircleSquare: ImageVector? = null

@Preview
@Composable
private fun CheckmarkCircleSquarePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.CheckmarkCircleSquare, contentDescription = null)
    }
}
