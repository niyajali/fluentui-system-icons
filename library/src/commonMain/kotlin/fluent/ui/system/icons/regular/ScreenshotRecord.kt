...
public val FluentUi.Regular.ScreenshotRecord: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ScreenshotRecordPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.ScreenshotRecord, contentDescription = null)
    }
}
