...
public val FluentUi.Regular.DataBarVerticalStar: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun DataBarVerticalStarPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.DataBarVerticalStar, contentDescription = null)
    }
}
