...
public val FluentUi.Light.TableMoveBelow: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun TableMoveBelowPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Light.TableMoveBelow, contentDescription = null)
    }
}
