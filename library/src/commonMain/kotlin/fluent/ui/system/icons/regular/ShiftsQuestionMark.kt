...
public val FluentUi.Regular.ShiftsQuestionMark: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Regular.ShiftsQuestionMark",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color(0xFF212121))) {
            ...
            curveTo(12.274f, 20.538f, 12.514f, 20.034f, 12.686f, 19.5f)
            lineTo(17.75f, 19.5f)
            ...
            lineTo(4.5f, 11.314f)
            curveTo(3.966f, 11.486f, 3.462f, 11.726f, 2.999f, 12.023f)
            lineTo(3f, 6.25f)
...
private fun ShiftsQuestionMarkPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.ShiftsQuestionMark, contentDescription = null)
    }
}
