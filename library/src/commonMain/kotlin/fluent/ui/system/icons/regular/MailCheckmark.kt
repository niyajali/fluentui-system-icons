...
public val FluentIcons.Regular.MailCheckmark: ImageVector
    get() {
        if (_MailCheckmark != null) {
            return _MailCheckmark!!
        }
        _MailCheckmark = ImageVector.Builder(
            name = "Regular.MailCheckmark",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
@Preview
@Composable
private fun MailCheckmarkPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.MailCheckmark, contentDescription = null)
    }
}
