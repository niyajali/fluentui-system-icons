...
public val FluentUi.Filled.WeatherSnowShowerDay: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun WeatherSnowShowerDayPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.WeatherSnowShowerDay, contentDescription = null)
    }
}
