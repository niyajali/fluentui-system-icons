...
public val FluentUi.Regular.ClipboardMathFormula: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ClipboardMathFormulaPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.ClipboardMathFormula, contentDescription = null)
    }
}
