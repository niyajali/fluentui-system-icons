...
public val FluentUi.Filled.AccessibilityQuestionMark: ImageVector by
...
private fun AccessibilityQuestionMarkPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.AccessibilityQuestionMark, contentDescription = null)
    }
}
