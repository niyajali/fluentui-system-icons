...
public val FluentUi.Filled.PictureInPicture: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun PictureInPicturePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.PictureInPicture, contentDescription = null)
    }
}
