...
public val FluentIcons.Filled.ChatMultipleCheckmark: ImageVector
    get() {
        if (_ChatMultipleCheckmark != null) {
            return _ChatMultipleCheckmark!!
        }
        _ChatMultipleCheckmark = ImageVector.Builder(
...
private var _ChatMultipleCheckmark: ImageVector? = null

@Preview
@Composable
private fun ChatMultipleCheckmarkPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.ChatMultipleCheckmark, contentDescription = null)
    }
}
