...
public val FluentUi.Regular.HapticStrong: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun HapticStrongPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.HapticStrong, contentDescription = null)
    }
}
