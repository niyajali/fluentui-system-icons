...
public val FluentUi.Filled.TextBulletList90: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun TextBulletList90Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.TextBulletList90, contentDescription = null)
    }
}
