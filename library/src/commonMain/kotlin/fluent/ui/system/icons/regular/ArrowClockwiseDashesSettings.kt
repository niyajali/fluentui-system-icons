...
public val FluentUi.Regular.ArrowClockwiseDashesSettings: ImageVector by
...
private fun ArrowClockwiseDashesSettingsPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.ArrowClockwiseDashesSettings, contentDescription = null)
    }
}
