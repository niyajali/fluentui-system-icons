...
public val FluentIcons.Filled.ReceiptSparkles: ImageVector
    get() {
        if (_ReceiptSparkles != null) {
            return _ReceiptSparkles!!
        }
        _ReceiptSparkles = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFF212121))) {
                ...
                curveTo(17.976f, 8.743f, 17.906f, 8.835f, 17.814f, 8.9f)
                ...
                curveTo(16.401f, 6.841f, 16.166f, 6.459f, 15.854f, 6.146f)
                close()
                ...
                close()
                moveTo(5.25f, 3f)
                horizontalLineTo(13.047f)
                curveTo(12.741f, 3.11f, 12.474f, 3.308f, 12.28f, 3.569f)
                ...
                curveTo(16.702f, 9.861f, 16.848f, 9.931f, 17f, 9.979f)
                verticalLineTo(14f)
...
@Preview
@Composable
private fun ReceiptSparklesPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.ReceiptSparkles, contentDescription = null)
    }
}
