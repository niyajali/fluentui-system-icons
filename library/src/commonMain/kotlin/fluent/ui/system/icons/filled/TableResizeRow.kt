...
public val FluentUi.Filled.TableResizeRow: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun TableResizeRowPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.TableResizeRow, contentDescription = null)
    }
}
