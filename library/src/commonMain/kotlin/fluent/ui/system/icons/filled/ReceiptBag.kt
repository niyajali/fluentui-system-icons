...
public val FluentUi.Filled.ReceiptBag: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ReceiptBagPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.ReceiptBag, contentDescription = null)
    }
}
