...
public val FluentUi.Filled.Cellular4G: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun Cellular4GPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.Cellular4G, contentDescription = null)
    }
}
