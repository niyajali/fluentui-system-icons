...
public val FluentUi.Regular.ArrowDownExclamation: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ArrowDownExclamationPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.ArrowDownExclamation, contentDescription = null)
    }
}
