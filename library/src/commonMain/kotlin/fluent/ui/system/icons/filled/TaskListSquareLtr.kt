...
public val FluentUi.Filled.TaskListSquareLtr: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun TaskListSquareLtrPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.TaskListSquareLtr, contentDescription = null)
    }
}
