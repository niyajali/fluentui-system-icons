...
public val FluentUi.Filled.VehicleSubway: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun VehicleSubwayPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.VehicleSubway, contentDescription = null)
    }
}
