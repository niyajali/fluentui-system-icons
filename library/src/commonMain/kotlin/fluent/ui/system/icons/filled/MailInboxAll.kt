...
public val FluentUi.Filled.MailInboxAll: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun MailInboxAllPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.MailInboxAll, contentDescription = null)
    }
}
