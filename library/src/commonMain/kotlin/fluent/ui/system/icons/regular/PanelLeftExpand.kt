...
public val FluentUi.Regular.PanelLeftExpand: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun PanelLeftExpandPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.PanelLeftExpand, contentDescription = null)
    }
}
