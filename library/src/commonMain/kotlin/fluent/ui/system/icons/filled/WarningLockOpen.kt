...
public val FluentIcons.Filled.WarningLockOpen: ImageVector
    get() {
        if (_WarningLockOpen != null) {
            return _WarningLockOpen!!
        }
        _WarningLockOpen = ImageVector.Builder(
...
private fun WarningLockOpenPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.WarningLockOpen, contentDescription = null)
    }
}
