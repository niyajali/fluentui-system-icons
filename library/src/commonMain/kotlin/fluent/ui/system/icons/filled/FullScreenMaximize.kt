...
public val FluentUi.Filled.FullScreenMaximize: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun FullScreenMaximizePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.FullScreenMaximize, contentDescription = null)
    }
}
