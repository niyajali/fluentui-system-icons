...
public val FluentUi.Regular.PhoneUpdateCheckmark: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun PhoneUpdateCheckmarkPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.PhoneUpdateCheckmark, contentDescription = null)
    }
}
