...
public val FluentUi.Filled.TextDescriptionLtr: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun TextDescriptionLtrPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.TextDescriptionLtr, contentDescription = null)
    }
}
