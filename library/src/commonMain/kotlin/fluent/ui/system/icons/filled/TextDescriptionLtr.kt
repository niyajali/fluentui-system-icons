...
public val FluentIcons.Filled.TextDescriptionLtr: ImageVector
    get() {
        if (_TextDescriptionLtr != null) {
            return _TextDescriptionLtr!!
        }
        _TextDescriptionLtr = ImageVector.Builder(
            name = "Filled.TextDescriptionLtr",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
@Preview
@Composable
private fun TextDescriptionLtrPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.TextDescriptionLtr, contentDescription = null)
    }
}
