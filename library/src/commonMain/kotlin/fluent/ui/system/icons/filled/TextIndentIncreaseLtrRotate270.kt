...
public val FluentIcons.Filled.TextIndentIncreaseLtrRotate270: ImageVector
    get() {
        if (_TextIndentIncreaseLtrRotate270 != null) {
            return _TextIndentIncreaseLtrRotate270!!
        }
        _TextIndentIncreaseLtrRotate270 = ImageVector.Builder(
            name = "Filled.TextIndentIncreaseLtrRotate270",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
@Preview
@Composable
private fun TextIndentIncreaseLtrRotate270Preview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.TextIndentIncreaseLtrRotate270, contentDescription = null)
    }
}
