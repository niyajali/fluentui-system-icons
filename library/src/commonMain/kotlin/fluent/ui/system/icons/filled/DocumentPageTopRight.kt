...
public val FluentUi.Filled.DocumentPageTopRight: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun DocumentPageTopRightPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.DocumentPageTopRight, contentDescription = null)
    }
}
