...
public val FluentUi.Regular.HomeGarage: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun HomeGaragePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.HomeGarage, contentDescription = null)
    }
}
