...
public val FluentUi.Regular.ShoppingBagPause: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ShoppingBagPausePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Regular.ShoppingBagPause, contentDescription = null)
    }
}
