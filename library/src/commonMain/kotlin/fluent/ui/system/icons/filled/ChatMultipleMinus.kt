...
public val FluentUi.Filled.ChatMultipleMinus: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun ChatMultipleMinusPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.ChatMultipleMinus, contentDescription = null)
    }
}
