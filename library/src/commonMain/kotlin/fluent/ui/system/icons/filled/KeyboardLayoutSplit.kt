...
public val FluentUi.Filled.KeyboardLayoutSplit: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun KeyboardLayoutSplitPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.KeyboardLayoutSplit, contentDescription = null)
    }
}
