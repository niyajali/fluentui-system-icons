...
public val FluentIcons.Regular.BriefcasePerson: ImageVector
    get() {
        if (_BriefcasePerson != null) {
            return _BriefcasePerson!!
        }
        _BriefcasePerson = ImageVector.Builder(
...
private var _BriefcasePerson: ImageVector? = null

@Preview
@Composable
private fun BriefcasePersonPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Regular.BriefcasePerson, contentDescription = null)
    }
}
