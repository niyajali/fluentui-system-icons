...
public val FluentIcons.Filled.VideoPersonPulse: ImageVector
    get() {
        if (_VideoPersonPulse != null) {
            return _VideoPersonPulse!!
        }
        _VideoPersonPulse = ImageVector.Builder(
...
private fun VideoPersonPulsePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.VideoPersonPulse, contentDescription = null)
    }
}
