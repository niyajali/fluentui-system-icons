...
public val FluentUi.Filled.VehicleCarProfile: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun VehicleCarProfilePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.VehicleCarProfile, contentDescription = null)
    }
}
