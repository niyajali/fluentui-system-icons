...
public val FluentIcons.Filled.VehicleCarProfile: ImageVector
    get() {
        if (_VehicleCarProfile != null) {
            return _VehicleCarProfile!!
        }
        _VehicleCarProfile = ImageVector.Builder(
            name = "Filled.VehicleCarProfile",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
...
private fun VehicleCarProfilePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentIcons.Filled.VehicleCarProfile, contentDescription = null)
    }
}
