...
public val FluentUi.Filled.TabDesktopImage: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
private fun TabDesktopImagePreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = FluentUi.Filled.TabDesktopImage, contentDescription = null)
    }
}
